 ...
 */
@Data
@Schema(description = "任务催办时发送消息的 DTO")
public class BpmMessageSendWhenTaskUrgeReqDTO {
    ...
    @Schema(description = "审批人的用户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    @NotNull(message = "审批人的用户编号不能为空")
    private Long assigneeUserId;

    @Schema(description = "催办人的用户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    @NotNull(message = "催办人的用户编号不能为空")
    private Long urgeUserId;

    @Schema(description = "催办消息", example = "请尽快处理")
