package cn.weitee.erp.module.bpm.convert.definition;
...
import cn.weitee.erp.module.bpm.controller.admin.base.dept.DeptSimpleBaseVO;
...
import cn.weitee.erp.module.bpm.controller.admin.definition.vo.model.BpmModelRespVO;
...
public interface BpmModelConvert {
    ...
    default BpmModelMetaInfoVO parseMetaInfo(Model model) {
        ...
        if (vo.getHasUnpublishedChanges() == null) {
            vo.setHasUnpublishedChanges(model.getDeploymentId() == null);
        }
