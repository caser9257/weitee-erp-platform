...
import cn.weitee.erp.module.bpm.controller.admin.definition.vo.process.BpmProcessDefinitionPageReqVO;
...
import static cn.weitee.erp.framework.common.util.collection.CollectionUtils.addIfNotNull;
...
public class BpmProcessDefinitionServiceImpl implements BpmProcessDefinitionService {
    ...
    @Resource
    private BpmProcessDefinitionInfoMapper bpmProcessDefinitionInfoMapper;

    @Resource
    private AdminUserApi adminUserApi;

    private final BpmNotificationPolicyValidator notificationPolicyValidator = new BpmNotificationPolicyValidator();
    ...
    public String createProcessDefinition(Model model, BpmModelMetaInfoVO modelMetaInfo,
        ...
        notificationPolicyValidator.validateForDeploy(modelMetaInfo.getNotificationPolicySetting());
        // 创建 Deployment 部署
        ...
        bpmProcessDefinitionInfoMapper.insert(definitionDO);
    ...
    public void updateProcessDefinitionSortByModelId(String modelId, Long sort) {
        bpmProcessDefinitionInfoMapper.updateByModelId(modelId, new BpmProcessDefinitionInfoDO().setSort(sort));
    }
    ...
    public BpmProcessDefinitionInfoDO getProcessDefinitionInfo(String id) {
        return bpmProcessDefinitionInfoMapper.selectByProcessDefinitionId(id);
    }

    @Override
    public List<BpmProcessDefinitionInfoDO> getProcessDefinitionInfoList(Collection<String> ids) {
        return bpmProcessDefinitionInfoMapper.selectListByProcessDefinitionIds(ids);
    }

    @Override
    public PageResult<ProcessDefinition> getProcessDefinitionPage(BpmProcessDefinitionPageReqVO pageVO) {
        ProcessDefinitionQuery query = repositoryService.createProcessDefinitionQuery();
        query.processDefinitionTenantId(ProcessEngineConfiguration.NO_TENANT_ID);
