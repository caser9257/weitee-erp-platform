...
import cn.weitee.erp.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceCopyPageReqVO;
import cn.weitee.erp.module.bpm.dal.dataobject.task.BpmProcessInstanceCopyDO;
import cn.weitee.erp.module.bpm.dal.mysql.task.BpmProcessInstanceCopyMapper;
...
public class BpmProcessInstanceCopyServiceImpl implements BpmProcessInstanceCopyService {
    ...
    public void createProcessInstanceCopy(Collection<Long> userIds, String reason, String processInstanceId,
        ...
        bpmProcessInstanceCopyMapper.insertBatch(copyList);
    }
    ...
    public PageResult<BpmProcessInstanceCopyDO> getProcessInstanceCopyPage(Long userId,
        ...
        return bpmProcessInstanceCopyMapper.selectPage(userId, pageReqVO);
    }

    @Override
    public void deleteProcessInstanceCopy(String processInstanceId) {
        bpmProcessInstanceCopyMapper.deleteByProcessInstanceId(processInstanceId);
    }
