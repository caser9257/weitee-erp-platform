package cn.weitee.erp.module.bpm.enums;
 ...
 * Bpm 错误码枚举类
 *
 * <p>bpm 系统，使用 1-009-000-000 段</p>
 */
public interface ErrorCodeConstants {

    // ========== 通用流程处理模块 1-009-000-000 ==========
    ...
    ErrorCode MODEL_DEPLOY_FAIL_NOTIFICATION_SCENE_NOT_CONFIG = new ErrorCode(1_009_002_009, "部署流程失败，原因：通知设置已启用，但未启用任何通知场景");
    ErrorCode MODEL_DEPLOY_FAIL_NOTIFICATION_CHANNEL_NOT_CONFIG = new ErrorCode(1_009_002_010, "部署流程失败，原因：通知场景({})未配置任何通知渠道");
    ErrorCode MODEL_DEPLOY_FAIL_NOTIFICATION_CONTENT_EMPTY = new ErrorCode(1_009_002_011, "部署流程失败，原因：通知场景({})的站内信正文不能为空");
    ErrorCode MODEL_DEPLOY_FAIL_NOTIFICATION_VARIABLE_ILLEGAL = new ErrorCode(1_009_002_012, "部署流程失败，原因：通知场景({})包含非法变量({})");
    ErrorCode MODEL_DEPLOY_FAIL_NOTIFICATION_SCENE_INVALID = new ErrorCode(1_009_002_013, "部署流程失败，原因：通知场景({})不存在");
    ErrorCode MODEL_DEPLOY_FAIL_NOTIFICATION_DING_TALK_TEMPLATE_EMPTY = new ErrorCode(1_009_002_014, "部署流程失败，原因：通知场景({})的钉钉模板编码不能为空");
    ...
    ErrorCode TASK_SIGN_CREATE_TYPE_ERROR = new ErrorCode(1_009_005_010, "任务加签：当前任务已{}，不能{}");
    ...
    // ========== BPM 审批平台 1-009-015-000 ==========
    ErrorCode APPROVAL_SCHEME_NOT_EXISTS = new ErrorCode(1_009_015_000, "审批方案不存在");
    ErrorCode APPROVAL_SCHEME_CODE_DUPLICATE = new ErrorCode(1_009_015_001, "审批方案编码【{}】已存在");
    ErrorCode APPROVAL_SCHEME_VERSION_NOT_EXISTS = new ErrorCode(1_009_015_002, "审批方案版本不存在");
    ErrorCode APPROVAL_SCHEME_VERSION_NOT_DRAFT = new ErrorCode(1_009_015_003, "当前版本不是草稿状态，不能编辑或提交");
    ErrorCode APPROVAL_SCHEME_DEFAULT_RULE_REQUIRED = new ErrorCode(1_009_015_004, "提交前必须配置一条默认兜底规则");
    ...
    ErrorCode APPROVAL_INSTANCE_SNAPSHOT_STATUS_CONFLICT = new ErrorCode(1_009_017_003, "审批运行时快照状态已被其他事务修改");
