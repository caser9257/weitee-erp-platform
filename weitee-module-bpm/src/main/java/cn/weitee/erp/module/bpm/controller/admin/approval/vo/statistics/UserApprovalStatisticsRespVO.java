package cn.weitee.erp.module.bpm.controller.admin.approval.vo.statistics;

import io.swagger.v3.oas.annotations.media.Schema;
import lombok.Data;

/**
 * 用户审批统计数据 Response VO
 */
@Data
@Schema(description = "用户审批统计数据 Response VO")
public class UserApprovalStatisticsRespVO {
