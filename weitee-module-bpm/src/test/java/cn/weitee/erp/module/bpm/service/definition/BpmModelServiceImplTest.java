...
class BpmModelServiceImplTest {
    ...
    void validateModelManager_shouldAllowSuperAdminEvenIfNotInManagerList() throws Exception {
        ...
        setField(service, "permissionApi", createProxy(
                Class.forName("cn.weitee.erp.module.system.api.permission.PermissionApi"),
                (methodName, args) -> {
    ...
    void saveModel_shouldMarkModelAsHavingUnpublishedChanges() throws Exception {
        ...
        Class<?> reqClass = Class.forName("cn.weitee.erp.module.bpm.controller.admin.definition.vo.model.BpmModelSaveReqVO");
    ...
    private Object instantiateService() throws Exception {
        Class<?> clazz = Class.forName("cn.weitee.erp.module.bpm.service.definition.BpmModelServiceImpl");
