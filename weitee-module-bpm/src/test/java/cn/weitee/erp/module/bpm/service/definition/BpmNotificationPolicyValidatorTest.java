...
class BpmNotificationPolicyValidatorTest {
    ...
    private void invokeValidate(String json) throws Exception {
        Class<?> validatorClass = Class.forName("cn.weitee.erp.module.bpm.service.definition.BpmNotificationPolicyValidator");
        Object validator = validatorClass.getDeclaredConstructor().newInstance();
        Class<?> settingClass = Class.forName(
                "cn.weitee.erp.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO$NotificationPolicySetting");
