...
@Schema(description = "管理后台 - AI 知识库文�?Response VO")
@Data
public class AiKnowledgeDocumentRespVO {
    ...
    @Schema(description = "文档名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Java 开发手�?)
    private String name;
    ...
    @Schema(description = "分片最�?Token �?, requiredMode = Schema.RequiredMode.REQUIRED, example = "512")
    private Integer segmentMaxTokens;

    @Schema(description = "召回次数", requiredMode = Schema.RequiredMode.REQUIRED, example = "10")
    private Integer retrievalCount;

    @Schema(description = "文档状�?, requiredMode = Schema.RequiredMode.REQUIRED, example = "0")
