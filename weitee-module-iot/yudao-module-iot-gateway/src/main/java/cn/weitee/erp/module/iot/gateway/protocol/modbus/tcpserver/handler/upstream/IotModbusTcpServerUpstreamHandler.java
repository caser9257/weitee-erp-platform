package cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.weitee.erp.module.iot.core.biz.IotDeviceCommonApi;
import cn.weitee.erp.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.weitee.erp.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.weitee.erp.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.weitee.erp.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.weitee.erp.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.weitee.erp.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
...
import cn.weitee.erp.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.weitee.erp.module.iot.gateway.service.device.IotDeviceService;
import cn.weitee.erp.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.weitee.erp.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.weitee.erp.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.weitee.erp.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.weitee.erp.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
