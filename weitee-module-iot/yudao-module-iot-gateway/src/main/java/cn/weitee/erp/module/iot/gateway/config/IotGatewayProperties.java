package cn.weitee.erp.module.iot.gateway.config;

import cn.weitee.erp.module.iot.core.enums.IotProtocolTypeEnum;
import cn.weitee.erp.module.iot.gateway.protocol.coap.IotCoapConfig;
import cn.weitee.erp.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.weitee.erp.module.iot.gateway.protocol.http.IotHttpConfig;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.weitee.erp.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.weitee.erp.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.weitee.erp.module.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.weitee.erp.module.iot.gateway.protocol.udp.IotUdpConfig;
import cn.weitee.erp.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
import lombok.Data;
...
@ConfigurationProperties(prefix = "weitee.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.weitee.erp.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.weitee.erp.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
