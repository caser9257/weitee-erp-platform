...
import cn.weitee.erp.module.iot.controller.admin.rule.vo.data.sink.IotDataSinkPageReqVO;
import cn.weitee.erp.module.iot.controller.admin.rule.vo.data.sink.IotDataSinkSaveReqVO;
import cn.weitee.erp.module.iot.dal.dataobject.rule.IotDataSinkDO;
import cn.weitee.erp.module.iot.dal.mysql.rule.IotDataSinkMapper;
...
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.DATA_SINK_DELETE_FAIL_USED_BY_RULE;
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.DATA_SINK_NAME_EXISTS;
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.DATA_SINK_NOT_EXISTS;
...
public class IotDataSinkServiceImpl implements IotDataSinkService {
    ...
    @Resource
    private IotDataSinkMapper iotDataSinkMapper;
    ...
    public Long createDataSink(IotDataSinkSaveReqVO createReqVO) {
        ...
        iotDataSinkMapper.insert(dataBridge);
    ...
    public void updateDataSink(IotDataSinkSaveReqVO updateReqVO) {
        ...
        iotDataSinkMapper.updateById(updateObj);
    }
    ...
    public void deleteDataSink(Long id) {
        ...
        // 删除
        iotDataSinkMapper.deleteById(id);
    }

    private void validateDataBridgeExists(Long id) {
        if (iotDataSinkMapper.selectById(id) == null) {
    ...
    private void validateDataSinkNameUnique(Long id, String name) {
        ...
        IotDataSinkDO dataSink = iotDataSinkMapper.selectByName(name);
        if (dataSink == null) {
            return;
        }
    ...
    public IotDataSinkDO getDataSink(Long id) {
        return iotDataSinkMapper.selectById(id);
    }
    ...
    public PageResult<IotDataSinkDO> getDataSinkPage(IotDataSinkPageReqVO pageReqVO) {
        return iotDataSinkMapper.selectPage(pageReqVO);
    }

    @Override
    public List<IotDataSinkDO> getDataSinkListByStatus(Integer status) {
        return iotDataSinkMapper.selectListByStatus(status);
    }
    ...
    public void validateDataSinksExist(Collection<Long> ids) {
        ...
        List<IotDataSinkDO> sinks = iotDataSinkMapper.selectByIds(ids);
