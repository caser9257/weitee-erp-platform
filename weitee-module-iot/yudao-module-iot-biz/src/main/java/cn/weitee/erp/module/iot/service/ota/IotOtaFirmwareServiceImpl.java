...
import cn.weitee.erp.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareCreateReqVO;
import cn.weitee.erp.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwarePageReqVO;
import cn.weitee.erp.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareUpdateReqVO;
import cn.weitee.erp.module.iot.dal.dataobject.ota.IotOtaFirmwareDO;
import cn.weitee.erp.module.iot.dal.mysql.ota.IotOtaFirmwareMapper;
...
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_NOT_EXISTS;
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_PRODUCT_VERSION_DUPLICATE;
...
public class IotOtaFirmwareServiceImpl implements IotOtaFirmwareService {
    ...
    @Resource
    private IotOtaFirmwareMapper iotOtaFirmwareMapper;
    @Lazy
    @Resource
    ...
    public Long createOtaFirmware(IotOtaFirmwareCreateReqVO saveReqVO) {
        // 1.1 校验固件产品 + 版本号不能重复
        if (iotOtaFirmwareMapper.selectByProductIdAndVersion(saveReqVO.getProductId(), saveReqVO.getVersion()) != null) {
        ...
        iotOtaFirmwareMapper.insert(firmware);
    ...
    public void updateOtaFirmware(IotOtaFirmwareUpdateReqVO updateReqVO) {
        ...
        iotOtaFirmwareMapper.updateById(updateObj);
    }

    @Override
    public IotOtaFirmwareDO getOtaFirmware(Long id) {
        return iotOtaFirmwareMapper.selectById(id);
    }

    @Override
    public IotOtaFirmwareDO getOtaFirmwareByProductIdAndVersion(Long productId, String version) {
        return iotOtaFirmwareMapper.selectByProductIdAndVersion(productId, version);
    }
    ...
    public List<IotOtaFirmwareDO> getOtaFirmwareList(Collection<Long> ids) {
        ...
        return iotOtaFirmwareMapper.selectByIds(ids);
    }

    @Override
    public PageResult<IotOtaFirmwareDO> getOtaFirmwarePage(IotOtaFirmwarePageReqVO pageReqVO) {
        return iotOtaFirmwareMapper.selectPage(pageReqVO);
    }

    @Override
    public IotOtaFirmwareDO validateFirmwareExists(Long id) {
        IotOtaFirmwareDO firmware = iotOtaFirmwareMapper.selectById(id);
        if (firmware == null) {
