...
import cn.weitee.erp.module.iot.controller.admin.ota.vo.task.IotOtaTaskCreateReqVO;
import cn.weitee.erp.module.iot.controller.admin.ota.vo.task.IotOtaTaskPageReqVO;
...
import cn.weitee.erp.module.iot.dal.dataobject.ota.IotOtaTaskDO;
import cn.weitee.erp.module.iot.dal.dataobject.ota.IotOtaTaskRecordDO;
import cn.weitee.erp.module.iot.dal.mysql.ota.IotOtaTaskMapper;
import cn.weitee.erp.module.iot.enums.ota.IotOtaTaskDeviceScopeEnum;
import cn.weitee.erp.module.iot.enums.ota.IotOtaTaskRecordStatusEnum;
import cn.weitee.erp.module.iot.enums.ota.IotOtaTaskStatusEnum;
...
public class IotOtaTaskServiceImpl implements IotOtaTaskService {
    ...
    @Resource
    private IotOtaTaskMapper iotOtaTaskMapper;
    ...
    public Long createOtaTask(IotOtaTaskCreateReqVO createReqVO) {
        ...
        if (iotOtaTaskMapper.selectByFirmwareIdAndName(firmware.getId(), createReqVO.getName()) != null) {
    ...
    public void cancelOtaTask(Long id) {
        ...
        // 2. 更新升级任务状态为已取消
        iotOtaTaskMapper.updateById(IotOtaTaskDO.builder()
    ...
    public IotOtaTaskDO getOtaTask(Long id) {
        return iotOtaTaskMapper.selectById(id);
    }

    @Override
    public PageResult<IotOtaTaskDO> getOtaTaskPage(IotOtaTaskPageReqVO pageReqVO) {
        return iotOtaTaskMapper.selectPage(pageReqVO);
    }

    @Override
    public void updateOtaTaskStatusEnd(Long taskId) {
        int updateCount = iotOtaTaskMapper.updateByIdAndStatus(taskId, IotOtaTaskStatusEnum.IN_PROGRESS.getStatus(),
    ...
    private IotOtaTaskDO validateUpgradeTaskExists(Long id) {
        IotOtaTaskDO upgradeTask = iotOtaTaskMapper.selectById(id);
