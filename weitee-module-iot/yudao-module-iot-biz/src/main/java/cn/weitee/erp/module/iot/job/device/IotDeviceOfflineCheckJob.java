package cn.weitee.erp.module.iot.job.device;
...
import cn.weitee.erp.module.iot.framework.iot.config.WeiteeIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private WeiteeIotProperties iotProperties;
