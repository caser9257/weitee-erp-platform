package cn.weitee.erp.module.iot.core.messagebus.core.rabbitmq;
...
public class IotRabbitMQMessageBus implements IotMessageBus {
    ...
    public void register(IotMessageSubscriber<?> subscriber) {
        ...
        // 1.2 创建消费容器
        SimpleMessageListenerContainer container = createContainer(queue, subscriber, type);
        container.start();
    ...
    private SimpleMessageListenerContainer createContainer(Queue queue, IotMessageSubscriber<?> subscriber, Type type) {
