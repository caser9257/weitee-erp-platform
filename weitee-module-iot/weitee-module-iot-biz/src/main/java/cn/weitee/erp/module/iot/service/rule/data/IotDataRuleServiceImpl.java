package cn.weitee.erp.module.iot.service.rule.data;
...
import cn.weitee.erp.module.iot.controller.admin.rule.vo.data.rule.IotDataRuleSaveReqVO;
...
import cn.weitee.erp.module.iot.dal.dataobject.rule.IotDataSinkDO;
import cn.weitee.erp.module.iot.dal.mysql.rule.IotDataRuleMapper;
...
import cn.weitee.erp.module.iot.service.rule.data.action.IotDataRuleAction;
...
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.DATA_RULE_NAME_EXISTS;
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.DATA_RULE_NOT_EXISTS;
...
public class IotDataRuleServiceImpl implements IotDataRuleService {
    ...
    @Resource
    private IotDataRuleMapper iotDataRuleMapper;
    ...
    public Long createDataRule(IotDataRuleSaveReqVO createReqVO) {
        ...
        iotDataRuleMapper.insert(dataRule);
    ...
    public void updateDataRule(IotDataRuleSaveReqVO updateReqVO) {
        ...
        iotDataRuleMapper.updateById(updateObj);
    }
    ...
    public void deleteDataRule(Long id) {
        ...
        // 删除
        iotDataRuleMapper.deleteById(id);
    }

    private void validateDataRuleExists(Long id) {
        if (iotDataRuleMapper.selectById(id) == null) {
    ...
    private void validateDataRuleNameUnique(Long id, String name) {
        ...
        IotDataRuleDO dataRule = iotDataRuleMapper.selectByName(name);
        if (dataRule == null) {
            return;
        }
    ...
    public List<IotDataRuleDO> getDataRuleListByConditionFromCache(Long deviceId, String method, String identifier) {
        // 1. 查询所有开启的数据流转规则
        List<IotDataRuleDO> rules = iotDataRuleMapper.selectListByStatus(CommonStatusEnum.ENABLE.getStatus());
        // 2. 内存里过滤匹配的规则
