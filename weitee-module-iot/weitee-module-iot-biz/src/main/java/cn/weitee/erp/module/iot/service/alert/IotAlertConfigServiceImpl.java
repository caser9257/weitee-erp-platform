package cn.weitee.erp.module.iot.service.alert;

import cn.weitee.erp.framework.common.pojo.PageResult;
import cn.weitee.erp.framework.common.util.object.BeanUtils;
import cn.weitee.erp.module.iot.controller.admin.alert.vo.config.IotAlertConfigPageReqVO;
import cn.weitee.erp.module.iot.controller.admin.alert.vo.config.IotAlertConfigSaveReqVO;
import cn.weitee.erp.module.iot.dal.dataobject.alert.IotAlertConfigDO;
import cn.weitee.erp.module.iot.dal.mysql.alert.IotAlertConfigMapper;
import cn.weitee.erp.module.iot.service.rule.scene.IotSceneRuleService;
...
import static cn.weitee.erp.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_NOT_EXISTS;
...
public class IotAlertConfigServiceImpl implements IotAlertConfigService {
    ...
    @Resource
    private IotAlertConfigMapper iotAlertConfigMapper;
    ...
    public Long createAlertConfig(IotAlertConfigSaveReqVO createReqVO) {
        ...
        iotAlertConfigMapper.insert(alertConfig);
    ...
    public void updateAlertConfig(IotAlertConfigSaveReqVO updateReqVO) {
        ...
        iotAlertConfigMapper.updateById(updateObj);
    }
    ...
    public void deleteAlertConfig(Long id) {
        ...
        // 删除
        iotAlertConfigMapper.deleteById(id);
    }

    private void validateAlertConfigExists(Long id) {
        if (iotAlertConfigMapper.selectById(id) == null) {
