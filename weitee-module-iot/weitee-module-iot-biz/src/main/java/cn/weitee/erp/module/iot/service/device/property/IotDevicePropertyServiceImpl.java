package cn.weitee.erp.module.iot.service.device.property;
...
import cn.weitee.erp.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import cn.weitee.erp.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
...
import cn.weitee.erp.module.iot.dal.dataobject.device.IotDevicePropertyDO;
...
import cn.weitee.erp.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import cn.weitee.erp.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import cn.weitee.erp.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import cn.weitee.erp.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import cn.weitee.erp.module.iot.dal.tdengine.IotDevicePropertyMapper;
import cn.weitee.erp.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import cn.weitee.erp.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import cn.weitee.erp.module.iot.framework.tdengine.core.TDengineTableField;
...
import static cn.weitee.erp.framework.common.util.collection.MapUtils.getBigDecimal;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void defineDevicePropertyData(Long productId) {
        ...
        try {
            oldFields.addAll(iotDevicePropertyMapper.getProductPropertySTableFieldList(product.getId()));
        } catch (Exception e) {
        ...
        if (CollUtil.isEmpty(oldFields)) {
            ...
            iotDevicePropertyMapper.createProductPropertySTable(product.getId(), newFields);
            return;
        }
        // 2.2 情况二：如果是修改的时候，需要更新表
        iotDevicePropertyMapper.alterProductPropertySTable(product.getId(), oldFields, newFields);
    }
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        if (CollUtil.isEmpty(properties)) {
            ...
            // 2.1 保存设备属性【数据】
            iotDevicePropertyMapper.insert(device, properties, LocalDateTimeUtil.toEpochMilli(message.getReportTime()));
    ...
    public List<IotDevicePropertyRespVO> getHistoryDevicePropertyList(IotDevicePropertyHistoryListReqVO listReqVO) {
        try {
            return iotDevicePropertyMapper.selectListByHistory(listReqVO);
