package cn.weitee.erp.module.iot.service.thingmodel;
...
import cn.weitee.erp.module.iot.controller.admin.thingmodel.vo.IotThingModelListReqVO;
import cn.weitee.erp.module.iot.controller.admin.thingmodel.vo.IotThingModelPageReqVO;
import cn.weitee.erp.module.iot.controller.admin.thingmodel.vo.IotThingModelSaveReqVO;
import cn.weitee.erp.module.iot.convert.thingmodel.IotThingModelConvert;
...
import cn.weitee.erp.module.iot.dal.mysql.thingmodel.IotThingModelMapper;
...
import cn.weitee.erp.module.iot.service.device.IotDeviceModbusPointService;
...
public class IotThingModelServiceImpl implements IotThingModelService {
    ...
    public Long createThingModel(IotThingModelSaveReqVO createReqVO) {
        ...
        iotThingModelMapper.insert(thingModel);
    ...
    public void updateThingModel(IotThingModelSaveReqVO updateReqVO) {
        ...
        iotThingModelMapper.updateById(thingModel);
    ...
    public void deleteThingModel(Long id) {
        // 1.1 校验功能是否存在
        IotThingModelDO thingModel = iotThingModelMapper.selectById(id);
        if (thingModel == null) {
        ...
        // 2. 删除功能
        iotThingModelMapper.deleteById(id);
    ...
    public PageResult<IotThingModelDO> getProductThingModelPage(IotThingModelPageReqVO pageReqVO) {
        return iotThingModelMapper.selectPage(pageReqVO);
    }

    @Override
    public List<IotThingModelDO> getThingModelList(IotThingModelListReqVO reqVO) {
        return iotThingModelMapper.selectList(reqVO);
    }
    ...
    public void validateThingModelListExists(Long productId, Set<String> identifiers) {
        ...
        List<IotThingModelDO> thingModels = iotThingModelMapper.selectListByProductIdAndIdentifiers(
    ...
    private void validateProductThingModelMapperExists(Long id) {
        if (iotThingModelMapper.selectById(id) == null) {
            throw exception(THING_MODEL_NOT_EXISTS);
        }
    }
    ...
    private void validateIdentifierUnique(Long id, Long productId, String identifier) {
        ...
        if (id == null) {
            ...
            // 1.2 校验唯一
            IotThingModelDO thingModel = iotThingModelMapper.selectByProductIdAndIdentifier(productId, identifier);
            if (thingModel != null) {
    ...
    private void validateNameUnique(Long productId, String name) {
        IotThingModelDO thingModel = iotThingModelMapper.selectByProductIdAndName(productId, name);
        if (thingModel != null) {
