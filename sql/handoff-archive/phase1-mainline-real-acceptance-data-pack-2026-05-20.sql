...
(905901, 'phase1_sale_mgr', @password_hash, '刘销售', '一期验收固定数据-销售负责人', @dept_id, '[]',
 'phase1.sale@test.local', '13800015001', 1, '', 0, '', NULL, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(905902, 'phase1_fin_mgr', @password_hash, '陈财务', '一期验收固定数据-财务负责人', @dept_id, '[]',
 'phase1.finance@test.local', '13800015002', 2, '', 0, '', NULL, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(905903, 'phase1_pm', @password_hash, '周项目', '一期验收固定数据-项目经理', @dept_id, '[]',
 'phase1.pm@test.local', '13800015003', 1, '', 0, '', NULL, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(905904, 'phase1_pc', @password_hash, '李计划', '一期验收固定数据-PC 负责人', @dept_id, '[]',
 'phase1.pc@test.local', '13800015004', 1, '', 0, '', NULL, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(905905, 'phase1_mc', @password_hash, '王物控', '一期验收固定数据-MC 负责人', @dept_id, '[]',
 'phase1.mc@test.local', '13800015005', 1, '', 0, '', NULL, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
...
VALUES
(903001, 0, '一期验收物料', 'PHASE1-MATERIAL', 1, 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(903002, 903001, '电子类', 'PHASE1-ELEC', 2, 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(903003, 903001, '五金包材类', 'PHASE1-HWPACK', 3, 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
name = VALUES(name),
code = VALUES(code),
sort = VALUES(sort),
...
VALUES
(903011, '件', 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(903012, '套', 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(903013, '箱', 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
name = VALUES(name),
status = VALUES(status),
updater = VALUES(updater),
...
(`id`, `parent_id`, `name`, `code`, `sort`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`)
VALUES
(904001, 0, '一期验收仓库分类', 'PHASE1-WH', 1, 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(904002, 904001, '原料仓', 'PHASE1-RAW', 10, 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(904003, 904001, '成品仓', 'PHASE1-FG', 20, 0, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
...
(900101, '海川制造有限公司', '李敏', '13911880001', '021-66000001', 'customer.hc@test.local', NULL, '一期验收客户-正常', 0, 1,
 '91110108MA01HC001X', 0.130000, '中国银行上海分行', '622202000000900101', '上海浦东新区', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(900102, '东海装备有限公司', '周宁', '13811770002', '0755-66000002', 'customer.dh@test.local', NULL, '一期验收客户-异常', 0, 2,
 '91310115MA01DH002X', 0.130000, '工商银行深圳分行', '622202000000900102', '深圳南山区', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(900103, '中原电子科技有限公司', '王悦', '13711870003', '010-66000003', 'customer.zy@test.local', NULL, '一期验收客户-边界', 0, 3,
 '91440106MA01ZY003X', 0.130000, '建设银行北京分行', '622202000000900103', '北京市朝阳区', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
name = VALUES(name),
...
(901101, '华东精工供应链有限公司', '王凯', '13817770001', '021-88000001', 'supplier.hd@test.local', NULL, '一期验收供应商-正常', 0, 1,
 '91310115MA02SUP001', 0.130000, '招商银行上海分行', '621483000000901101', '上海嘉定区', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(901102, '深港电子元件有限公司', '赵强', '13817770002', '0755-88000002', 'supplier.sg@test.local', NULL, '一期验收供应商-异常', 0, 2,
 '91440300MA02SUP002', 0.130000, '建设银行深圳分行', '621483000000901102', '深圳宝安区', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(901103, '广州包材贸易有限公司', '陈涛', '13817770003', '020-88000003', 'supplier.gz@test.local', NULL, '一期验收供应商-边界', 0, 3,
 '91440101MA02SUP003', 0.090000, '工商银行广州分行', '621483000000901103', '广州市黄埔区', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
name = VALUES(name),
contact = VALUES(contact),
mobile = VALUES(mobile),
...
VALUES
(905101, '招商银行结算户', 'ACC-001', '一期验收付款账户', 0, 1, b'1', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(905102, '工商银行收款户', 'ACC-002', '一期验收收款账户', 0, 2, b'0', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
name = VALUES(name),
no = VALUES(no),
remark = VALUES(remark),
...
(902101, 'PJ-20260520-001', '海川二期交付项目', 'DELIVERY', 'SELF_RESEARCH', 'MANUAL', NULL, NULL,
 ...
 '计划已确认', '物料已确认', '2026-05-31', '正常链路项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(902102, 'PJ-20260520-002', '深港来料加工批次A', 'RESEARCH', 'TOLL_MANUFACTURING', 'MANUAL', NULL, NULL,
 ...
 NULL, NULL, '2026-06-05', '异常链路项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(902103, 'PJ-20260520-003', '中原工艺验证项目', 'PROCESS_VALIDATION', 'CUSTOMER_SUPPLIED', 'MANUAL', NULL, NULL,
 ...
 '边界场景计划已确认', NULL, '2026-06-10', '边界链路项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
`name` = VALUES(`name`),
...
VALUES
(906001, 'LEDGER-FIN-001', '财务主账簿', 0, 1, b'1', '一期验收固定账簿', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
name = VALUES(name),
status = VALUES(status),
sort = VALUES(sort),
...
(id, ledger_id, parent_id, subject_code, subject_name, subject_type, balance_direction, leaf, status, sort, remark,
 creator, create_time, updater, update_time, deleted, tenant_id)
VALUES
(907001, 906001, NULL, '1001', '库存现金', 10, 10, b'1', 0, 10, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907002, 906001, NULL, '1002', '银行存款', 10, 10, b'1', 0, 20, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907003, 906001, NULL, '1122', '应收账款', 20, 10, b'1', 0, 30, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907004, 906001, NULL, '2202', '应付账款', 20, 20, b'1', 0, 40, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907005, 906001, NULL, '1403', '原材料', 10, 10, b'1', 0, 50, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907006, 906001, NULL, '1405', '库存商品', 10, 10, b'1', 0, 60, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907007, 906001, NULL, '5001', '生产成本', 40, 10, b'1', 0, 70, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907008, 906001, NULL, '6001', '主营业务收入', 40, 20, b'1', 0, 80, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907009, 906001, NULL, '6401', '主营业务成本', 50, 10, b'1', 0, 90, '一期验收科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
ledger_id = VALUES(ledger_id),
parent_id = VALUES(parent_id),
...
(id, ledger_id, report_type, item_category, item_code, item_name, status, sort, remark,
 creator, create_time, updater, update_time, deleted, tenant_id)
VALUES
(907101, 906001, 10, 10, 'BS-CASH', '货币资金', 0, 10, '一期验收报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907102, 906001, 10, 20, 'BS-AR', '应收账款', 0, 20, '一期验收报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907103, 906001, 10, 30, 'BS-AP', '应付账款', 0, 30, '一期验收报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907104, 906001, 10, 40, 'BS-INV', '存货', 0, 40, '一期验收报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907105, 906001, 20, 10, 'IS-REV', '营业收入', 0, 10, '一期验收报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907106, 906001, 20, 20, 'IS-COST', '营业成本', 0, 20, '一期验收报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
ledger_id = VALUES(ledger_id),
...
VALUES
(907201, 907101, '1001', 50, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907202, 907101, '1002', 50, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907203, 907102, '1122', 50, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907204, 907103, '2202', 60, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907205, 907104, '1403', 50, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907206, 907104, '1405', 50, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907207, 907105, '6001', 40, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907208, 907106, '6401', 30, 1, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
...
VALUES
(907301, 906001, 11, '采购入库自动凭证模板', 0, b'1', '采购入库自动生成凭证', '一期验收凭证模板', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
ledger_id = VALUES(ledger_id),
...
(id, template_id, entry_no, entry_direction, subject_code, subject_name, amount_source, amount_source_value, summary,
 creator, create_time, updater, update_time, deleted, tenant_id)
VALUES
(907311, 907301, 1, 10, '1403', '原材料', 10, 0.000000, '确认采购入库', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907312, 907301, 2, 20, '2202', '应付账款', 20, 0.000000, '确认采购入库', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
...
(910102, 'SO-20260520-002', 30, NULL, 900102, 902102, 'TOLL_MANUFACTURING', NULL, 'PROCESSING_FEE', 903103,
 ...
 0.000000, 0.000000, 'NOT_READY', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
...
(911102, 'PO-20260520-002', 20, NULL, 901102, 905101, '2026-05-20 10:50:00', 50.000000, 4200.000000, 4200.000000, 0.000000,
 ...
 50.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(911103, 'PO-20260520-003', 20, NULL, 901103, 905101, '2026-05-20 11:30:00', 1.000000, 1.020000, 1.020000, 0.000000,
 ...
 0.500000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
status = VALUES(status),
process_instance_id = VALUES(process_instance_id),
...
(911201, 911101, 903101, 902101, 903011, 86.000000, 0.000000, NULL, NULL,
 100.000000, 8600.000000, 0.000000, 0.000000, '正常场景-工业控制板A', 100.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(911202, 911102, 903103, 902102, 903012, 84.000000, 0.000000, NULL, NULL,
 50.000000, 4200.000000, 0.000000, 0.000000, '异常场景-电子连接器套装', 50.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(911203, 911103, 903104, 902103, 903013, 1.020000, 0.000000, NULL, NULL,
 1.000000, 1.020000, 0.000000, 0.000000, '边界场景-包装箱套装', 0.500000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
order_id = VALUES(order_id),
product_id = VALUES(product_id),
project_id = VALUES(project_id),
...
(id, voucher_id, entry_no, summary, subject_code, subject_name, debit_amount, credit_amount,
 creator, create_time, updater, update_time, deleted, tenant_id)
VALUES
(911911, 911901, 1, '确认采购入库', '1403', '原材料', 8600.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(911912, 911901, 2, '确认采购入库', '2202', '应付账款', 0.000000, 8600.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
...
VALUES
(910701, 910101, 'APPROVE', 10, 20, '正常链路订单审核通过，允许推进交付。', 'codex', '2026-05-20 09:20:00', 'codex', NOW(), b'0', @tenant_id),
(910702, 910102, 'REJECT', 10, 30, '项目资料未齐，来料清单与加工费口径未确认。', 'codex', '2026-05-20 15:20:00', 'codex', NOW(), b'0', @tenant_id),
(910703, 910103, 'APPROVE', 10, 20, '边界场景订单审核通过，允许最小金额联调。', 'codex', '2026-05-20 11:30:00', 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
order_id = VALUES(order_id),
...
VALUES
(910801, 910102, '项目资料未齐，来料清单与加工费口径未确认。', 'codex', '2026-05-20 15:20:00', 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
order_id = VALUES(order_id),
reason = VALUES(reason),
creator = VALUES(creator),
...
(id, order_id, action_type, before_status, after_status, reason, creator, create_time, updater, update_time, deleted, tenant_id)
VALUES
(912001, 911101, 'APPROVE', 10, 20, '正常链路采购订单审核通过。', 'codex', '2026-05-20 09:50:00', 'codex', NOW(), b'0', @tenant_id),
(912002, 911102, 'APPROVE', 10, 20, '异常链路采购订单审核通过，进入质检异常验证。', 'codex', '2026-05-20 11:10:00', 'codex', NOW(), b'0', @tenant_id),
(912003, 911103, 'APPROVE', 10, 20, '边界链路采购订单审核通过。', 'codex', '2026-05-20 11:45:00', 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
order_id = VALUES(order_id),
action_type = VALUES(action_type),
before_status = VALUES(before_status),
...
(id, ledger_id, period_id, period_sort, subject_code, subject_name,
 ...
 creator, create_time, updater, update_time, deleted, tenant_id)
VALUES
(907401, 906001, 906101, 202605, '1001', '库存现金', 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907402, 906001, 906101, 202605, '1002', '银行存款', 100000.000000, 0.000000, 12800.500000, 8600.510000, 104199.990000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907403, 906001, 906101, 202605, '1122', '应收账款', 0.000000, 0.000000, 12800.990000, 12800.500000, 0.490000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907404, 906001, 906101, 202605, '2202', '应付账款', 0.000000, 0.000000, 8600.510000, 12801.020000, 0.000000, 4200.510000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907405, 906001, 906101, 202605, '1403', '原材料', 0.000000, 0.000000, 8601.020000, 0.000000, 8601.020000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907406, 906001, 906101, 202605, '1405', '库存商品', 0.000000, 0.000000, 12800.990000, 0.000000, 12800.990000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907407, 906001, 906101, 202605, '5001', '生产成本', 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907408, 906001, 906101, 202605, '6001', '主营业务收入', 0.000000, 0.000000, 0.000000, 12800.990000, 0.000000, 12800.990000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
(907409, 906001, 906101, 202605, '6401', '主营业务成本', 0.000000, 0.000000, 8601.020000, 0.000000, 8601.020000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
ledger_id = VALUES(ledger_id),
period_id = VALUES(period_id),
period_sort = VALUES(period_sort),
