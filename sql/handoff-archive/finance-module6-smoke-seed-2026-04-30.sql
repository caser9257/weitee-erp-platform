...
INSERT INTO erp_finance_subject (
    ...
    (@ledger_id, NULL, '1001', '库存现金', 10, 10, b'1', 0, 10, '模块6 smoke 科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, NULL, '1002', '银行存款', 10, 10, b'1', 0, 20, '模块6 smoke 科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, NULL, '2202', '应付账款', 20, 20, b'1', 0, 30, '模块6 smoke 科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, NULL, '4001', '实收资本', 30, 20, b'1', 0, 40, '模块6 smoke 科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, NULL, '4103', '本年利润', 30, 20, b'1', 0, 50, '模块6 smoke 科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, NULL, '6001', '主营业务收入', 40, 20, b'1', 0, 60, '模块6 smoke 科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, NULL, '6401', '主营业务成本', 50, 10, b'1', 0, 70, '模块6 smoke 科目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
...
INSERT INTO erp_finance_report_item (
    ...
    (@ledger_id, 10, 10, 'BS-CASH', '货币资金', 0, 10, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, 10, 20, 'BS-AP', '应付账款', 0, 20, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, 10, 30, 'BS-CAPITAL', '实收资本', 0, 30, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, 10, 30, 'BS-PROFIT', '本年利润', 0, 40, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, 20, 40, 'IS-REVENUE', '营业收入', 0, 10, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, 20, 50, 'IS-COST', '营业成本', 0, 20, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, 30, 60, 'CF-INFLOW', '现金流入', 0, 10, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, 30, 70, 'CF-OUTFLOW', '现金流出', 0, 20, '模块6 smoke 报表项目', 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
...
INSERT INTO erp_finance_subject_balance (
    ...
    (@ledger_id, @period_id, 202604, '1001', '库存现金', 0, 0, 6800.000000, 0.000000, 6800.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, @period_id, 202604, '1002', '银行存款', 0, 0, 20000.000000, 5000.000000, 15000.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, @period_id, 202604, '2202', '应付账款', 0, 0, 0.000000, 8000.000000, 0.000000, 8000.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, @period_id, 202604, '4001', '实收资本', 0, 0, 0.000000, 12000.000000, 0.000000, 12000.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, @period_id, 202604, '4103', '本年利润', 0, 0, 0.000000, 0.000000, 0.000000, 1800.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, @period_id, 202604, '6001', '主营业务收入', 0, 0, 0.000000, 3000.000000, 0.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id),
    (@ledger_id, @period_id, 202604, '6401', '主营业务成本', 0, 0, 1200.000000, 0.000000, 0.000000, 0.000000, 'codex', NOW(), 'codex', NOW(), b'0', @tenant_id)
ON DUPLICATE KEY UPDATE
    subject_name = VALUES(subject_name),
