  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/erp/mrp/production-inbound/index.vue'),
        name: 'ErpProductionInboundPage',
        meta: {
          noCache: true,
          hidden: true,
          canTo: true,
          title: '自制入库',
          activeMenu: '/scm/production-inbound'
        }
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/erp/finance/expense/index.vue'),
        name: 'ErpFinanceExpenseCompatPage',
        meta: {
          noCache: true,
          hidden: true,
          canTo: true,
          title: '研发报销 / 零星采购',
          activeMenu: '/finance/expense'
        }
      },
      {
