...
assert.match(
  projectDrivenSource,
  /path:\s*'voucher-template'[\s\S]*component:\s*'erp\/finance\/voucher-template\/index'[\s\S]*componentName:\s*'ErpFinanceVoucherTemplate'/,
  'projectDriven.ts 应该提供凭证模板正式菜单入口，避免财务模板页无法从主菜单进入'
)
