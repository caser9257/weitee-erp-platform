<template>
  ...
  <ContentWrap class="contract-page__filter-card" :body-style="{ padding: '24px' }" :class="getToneCardClass('emerald')">
    ...
    >
      <div class="contract-query__grid">
      ...
      <div class="contract-query__footer">
        <div></div>
        <div class="contract-query__actions">
  ...
  <ContentWrap class="contract-page__list-card" :body-style="{ padding: '24px' }" :class="getToneCardClass('slate')">
    <div class="contract-page__tabs">
    ...
    <div class="contract-table__scroll">
      <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true" class="contract-table">
    <el-tabs v-model="activeName" @tab-click="handleTabClick">
      <el-tab-pane label="我负责的" name="1" />
      <el-tab-pane label="我参与的" name="2" />
      <el-tab-pane label="下属负责的" name="3" />
...
import { getToneCardClass } from '../../erp/stock/shared/stockTone'
...
.contract-query__grid {
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: 14px;
}

.contract-query__footer {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 12px;
