<template>
  <el-drawer v-model="drawerVisible" title="BOM详情" size="960px" destroy-on-close>
    <div v-loading="detailLoading">
      ...
      <el-empty v-else description="暂无 BOM 数据" />
    </div>
  </el-drawer>
</template>
...
defineOptions({ name: 'BomDetailDrawer' })
...
const open = async (id: number) => {
  ...
  try {
    detailData.value = await BomApi.getBom(id)
  } finally {
