<template>
  ...
  <ContentWrap class="product-unit-page__header-card" :body-style="{ padding: '24px' }" :class="getToneCardClass('blue')">
    <div class="product-unit-page__header">
      ...
      <div class="product-unit-page__actions">
        ...
        >
          <Icon icon="ep:plus" class="mr-5px" /> 新增单位
        </el-button>
        <el-button
          plain
          @click="handleExport"
  ...
  <ContentWrap class="product-unit-page__filter-card" :body-style="{ padding: '24px' }" :class="getToneCardClass('emerald')">
    ...
    <el-form
      ...
      :model="queryParams"
      label-position="top"
      class="product-unit-query"
    >
      <div class="product-unit-query__grid">
      ...
      <div class="product-unit-query__footer">
        <div></div>
        <div class="product-unit-query__actions">
  ...
  <ContentWrap class="product-unit-page__list-card" :body-style="{ padding: '24px' }" :class="getToneCardClass('slate')">
    <div class="product-unit-table__scroll">
...
.product-unit-page__count {
  margin-top: 8px;
  color: #64748b;
  font-size: 13px;
}

.product-unit-page__actions {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
}

.product-unit-page__section-title {
  margin-bottom: 16px;
  color: #0f172a;
  font-size: 16px;
  font-weight: 600;
...
.product-unit-query__grid {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 14px;
}

.product-unit-query__footer {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 12px;
...
.product-unit-query__actions {
  display: flex;
  align-items: center;
  gap: 10px;
}

.product-unit-table__scroll {
  overflow-x: auto;
}
...
.product-unit-page__record-count {
  color: #64748b;
  font-size: 13px;
  line-height: 20px;
}
