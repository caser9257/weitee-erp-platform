...
const appCertUpload: UploadRequestHandler = (event: any) => {
...
const alipayPublicCertUpload: UploadRequestHandler = (event: any) => {
  const readFile = new FileReader()
  readFile.onload = (e: any) => {
...
const rootCertUpload: UploadRequestHandler = (event: any) => {
  const readFile = new FileReader()
  readFile.onload = (e: any) => {
