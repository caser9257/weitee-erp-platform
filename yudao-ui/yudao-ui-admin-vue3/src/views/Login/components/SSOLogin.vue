<template>
  <div v-show="ssoVisible" :class="['login-sso-form', { 'login-sso-form--dark': props.isDarkMode }]">
    <!-- 应用名 -->
    ...
    <div>
      <el-form :model="formData" class="login-form">
        <!-- 授权范围的选择 -->
        <div class="login-sso-form__desc">{{ loginText('ssoFormDesc') }}</div>
...
.login-sso-form--dark,
.login-sso-form--dark .login-sso-form__desc,
.login-sso-form--dark :deep(.el-tabs__item),
.login-sso-form--dark :deep(.el-checkbox) {
  color: #8d99ad;
}
</style>
