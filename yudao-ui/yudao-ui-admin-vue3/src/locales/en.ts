export default {
  ...
  sys: {
    ...
    login: {
      ...
      ssoEyebrow: 'Secure Authorization',
      mobileSignInFormTitle: 'Mobile sign in',
      qrSignInFormTitle: 'Qr code sign in',
      signInFormTitle: 'Sign in',
      signUpFormTitle: 'Sign up',
      forgetFormTitle: 'Reset password',
      forgetFormDesc: 'Verify your identity information and reset the account password.',
      ssoFormDesc: 'Confirm the authorized scope and continue to the third-party system.',
      signInTitle: 'Welcome to Wave Technic Manufacturing Platform',
      signInDesc: 'Enter your account information to access the manufacturing collaboration workspace.',
      heroBrandEnglish: 'WAVE TECHNIC',
      heroBrandChinese: 'Wave Technic ERP System',
      heroCapability: 'RF communication, optical module test and timing synchronization control center.',
      boardStatus: 'NODE ACTIVE',
      card1Title: 'RF Power Amplifier Stability',
      card1Tag: 'Stable',
      card2Title: 'Optical Yield Monitoring',
      card2Metric1: 'Yield',
      card2Metric2: 'Tracking',
      card3Title: 'Timing And Position Calibration',
      card3Metric1: 'Sync Error',
      card3Metric2: 'Precision Calibration',
      heroTagMes: 'RF COMMUNICATION',
      heroTagErp: 'OPTICAL COMMUNICATION',
      heroTagWms: 'DIGITAL COMMUNICATION',
      recommendEngine: 'RECOMMEND ENGINE : CHROMIUM BROWSER',
      ...
      // placeholder
      accountPlaceholder: 'Please input work account',
