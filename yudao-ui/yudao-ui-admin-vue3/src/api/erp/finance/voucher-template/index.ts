...
export interface ErpFinanceVoucherTemplateItemVO {
  ...
  amountSourceValue?: string | number
  summary?: string
}
...
export const FinanceVoucherTemplateApi = {
  getVoucherTemplatePage: async (params: ErpFinanceVoucherTemplatePageReqVO) => {
    return await request.get({ url: '/erp/finance-voucher-template/page', params })
  },

  getVoucherTemplate: async (id: number) => {
    return await request.get<ErpFinanceVoucherTemplateVO>({ url: '/erp/finance-voucher-template/get', params: { id } })
  },

  createVoucherTemplate: async (data: ErpFinanceVoucherTemplateSaveReqVO) => {
    return await request.post({ url: '/erp/finance-voucher-template/create', data })
  },

  updateVoucherTemplate: async (data: ErpFinanceVoucherTemplateSaveReqVO) => {
    return await request.put({ url: '/erp/finance-voucher-template/update', data })
  },

  deleteVoucherTemplate: async (id: number) => {
    return await request.delete({ url: '/erp/finance-voucher-template/delete', params: { id } })
  },
