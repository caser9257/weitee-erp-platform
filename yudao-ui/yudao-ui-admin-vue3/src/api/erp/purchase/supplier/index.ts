...
export interface SupplierBatchUpdateReqVO {
  ids: number[]
  fieldKey: string
  mode: string
  value: string
...
export interface SupplierBatchUpdateResultVO {
  successCount: number
  failureCount: number
  updatedIds: number[]
  failedItems: Array<{
...
export const SupplierApi = {
  ...
  // 批量修改供应商
  batchUpdateSupplier: async (data: SupplierBatchUpdateReqVO) => {
    return await request.put<SupplierBatchUpdateResultVO>({
      url: `/erp/supplier/batch-update`,
      data
    })
  },
