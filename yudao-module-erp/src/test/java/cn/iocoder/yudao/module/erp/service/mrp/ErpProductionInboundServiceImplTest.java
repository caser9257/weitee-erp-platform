...
class ErpProductionInboundServiceImplTest {
    ...
    void setUp() throws Exception {
        ...
        setField(service, "productionOrderService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.mrp.ErpProductionOrderService", (methodName, args) -> {
        ...
        setField(service, "productionCostService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.mrp.ErpProductionCostService", (methodName, args) -> {
        ...
        setField(service, "stockRecordService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.stock.ErpStockRecordService", (methodName, args) -> {
