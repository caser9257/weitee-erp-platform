...
class ErpFinanceRdMonthEndServiceImplTest {
    ...
    void executeMonthEnd_shouldGenerateExpenseCarryForwardVoucherAndDepreciation() throws Exception {
        ...
        setField(service, "financeLedgerService", createProxy(ErpFinanceLedgerService.class, (methodName, args) -> {
            if ("getDefaultFinanceLedger".equals(methodName)) {
                return new cn.iocoder.yudao.module.erp.dal.dataobject.finance.ErpFinanceLedgerDO().setId(99601L).setName("默认账簿");
            }
        ...
        setField(service, "financeVoucherEntryMapper", createProxy(cn.iocoder.yudao.module.erp.dal.mysql.finance.ErpFinanceVoucherEntryMapper.class, (methodName, args) -> {
    ...
    void executeMonthEnd_shouldReuseExistingExpenseCarryForwardVoucher() throws Exception {
        ...
        setField(service, "financeVoucherEntryMapper", createProxy(cn.iocoder.yudao.module.erp.dal.mysql.finance.ErpFinanceVoucherEntryMapper.class, (methodName, args) -> List.of()));
