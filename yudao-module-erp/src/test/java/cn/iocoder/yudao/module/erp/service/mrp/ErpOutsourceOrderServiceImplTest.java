...
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceIssueCreateReqVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceInboundCreateReqVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceFeeSaveReqVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceLossDetailRespVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceLossEntryCreateReqVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceOrderCloseReqVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceOrderSaveReqVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceReconciliationRespVO;
import cn.iocoder.yudao.module.erp.controller.admin.mrp.vo.outsource.ErpOutsourceReturnCreateReqVO;
...
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceFeeMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceInboundMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceIssueBatchMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceIssueItemMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceIssueMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceLossDetailMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceOrderMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceReturnBatchMapper;
import cn.iocoder.yudao.module.erp.dal.mysql.mrp.ErpOutsourceReturnMapper;
...
class ErpOutsourceOrderServiceImplTest {
    ...
    void createOutsourceOrder_shouldRequireBomForBomType() throws Exception {
        ...
        setField(service, "supplierService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.purchase.ErpSupplierService", (methodName, args) -> null));
        setField(service, "productService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.product.ErpProductService", (methodName, args) -> null));
        setField(service, "bomService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.mrp.ErpBomService", (methodName, args) -> null));
    ...
    void createOutsourceOrder_shouldRejectBomOfDifferentProduct() throws Exception {
        ...
        setField(service, "productService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.product.ErpProductService", (methodName, args) -> null));
        setField(service, "bomService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.mrp.ErpBomService", (methodName, args) -> {
    ...
    void createOutsourceInbound_shouldCalculateInboundCostFromNetMaterialAndFee() throws Exception {
        ...
        setField(service, "warehouseService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.stock.ErpWarehouseService", (methodName, args) -> null));
        setField(service, "noRedisDAO", new ErpNoRedisDAO() {
            @Override
            public String generate(String prefix) {
    ...
    void createOutsourceIssue_shouldPersistSupplementIssueType() throws Exception {
        ...
        setField(service, "purchaseInItemMapper", createProxyByName(
                "cn.iocoder.yudao.module.erp.dal.mysql.purchase.ErpPurchaseInItemMapper", (methodName, args) -> {
    ...
    void getOutsourceLossDetail_shouldBuildBatchLevelLossView() throws Exception {
        ...
        setField(service, "productService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.product.ErpProductService", (methodName, args) -> {
        ...
        setField(service, "warehouseService", createProxyByName(
                "cn.iocoder.yudao.module.erp.service.stock.ErpWarehouseService", (methodName, args) -> {
