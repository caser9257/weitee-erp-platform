...
class ErpFinancePageSmokeTest {
    ...
    private Object createApStatementServiceProxy() {
        return Proxy.newProxyInstance(
                ...
                new Class<?>[]{cn.iocoder.yudao.module.erp.service.finance.ErpApStatementService.class},
    ...
    private Object createApEstimateServiceWithDirtyCreatorProxy() {
        return Proxy.newProxyInstance(
                ...
                new Class<?>[]{cn.iocoder.yudao.module.erp.service.finance.ErpApEstimateService.class},
                (proxy, method, args) -> {
    ...
    private Object createProductServiceProxy() {
        return Proxy.newProxyInstance(
                ErpApEstimateController.class.getClassLoader(),
                new Class<?>[]{cn.iocoder.yudao.module.erp.service.product.ErpProductService.class},
    ...
    private Object createWarehouseServiceProxy() {
        return Proxy.newProxyInstance(
                ErpApEstimateController.class.getClassLoader(),
                new Class<?>[]{cn.iocoder.yudao.module.erp.service.stock.ErpWarehouseService.class},
    ...
    private Object createProjectServiceProxy() {
        return Proxy.newProxyInstance(
                ErpApEstimateController.class.getClassLoader(),
                new Class<?>[]{cn.iocoder.yudao.module.erp.service.project.ErpProjectService.class},
