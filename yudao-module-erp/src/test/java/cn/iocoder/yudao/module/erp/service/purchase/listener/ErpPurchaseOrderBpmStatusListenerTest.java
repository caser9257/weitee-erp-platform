...
class ErpPurchaseOrderBpmStatusListenerTest {
    ...
    void onApplicationEvent_shouldRouteMatchingPurchaseOrderEvent() throws Exception {
        ...
        setField(listener, "purchaseOrderBpmService", createProxyByName("cn.iocoder.yudao.module.erp.service.purchase.ErpPurchaseOrderBpmService",
                (methodName, args) -> {
    ...
    private Object instantiateListener() throws Exception {
        Class<?> clazz = Class.forName("cn.iocoder.yudao.module.erp.service.purchase.listener.ErpPurchaseOrderBpmStatusListener");
