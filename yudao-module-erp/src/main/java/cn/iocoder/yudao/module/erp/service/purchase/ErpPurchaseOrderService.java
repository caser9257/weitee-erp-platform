...
public interface ErpPurchaseOrderService {
     ...
     * @return 批量更新结果
     */
    ErpPurchaseOrderBatchUpdateResultVO updatePurchaseOrderBatch(@Valid ErpPurchaseOrderBatchUpdateReqVO reqVO);
    ...
    List<ErpPurchaseOrderAuditLogDO> getPurchaseOrderAuditLogListByOrderId(Long orderId);

    List<ErpPurchaseOrderRejectLogDO> getPurchaseOrderRejectLogListByOrderId(Long orderId);
