...
public interface ErpStockOutMapper extends BaseMapperX<ErpStockOutDO> {
    ...
    default List<ErpStockOutDO> selectApprovedListForBatchRebuild(Long id, Integer limit) {
        return selectList(new LambdaQueryWrapper<ErpStockOutDO>()
                .eq(ErpStockOutDO::getStatus, ErpAuditStatus.APPROVE.getStatus())
                .eq(id != null, ErpStockOutDO::getId, id)
                .orderByAsc(ErpStockOutDO::getId)
                .last("LIMIT " + limit));
    }
