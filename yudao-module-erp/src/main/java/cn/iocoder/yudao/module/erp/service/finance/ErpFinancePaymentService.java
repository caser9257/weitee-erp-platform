...
public interface ErpFinancePaymentService {
     ...
     * @param reason 作废原因
     */
    void voidFinancePayment(Long id, String reason);
    ...
    List<ErpFinancePaymentDO> getFinancePaymentListByIds(Collection<Long> ids);
     ...
     * @return 核销记录列表
     */
    List<ErpFinancePaymentAllocateDO> getFinancePaymentAllocateListByPaymentId(Long paymentId);

    List<ErpFinancePaymentAllocateDO> getFinancePaymentAllocateListByStatementIds(Collection<Long> statementIds);
