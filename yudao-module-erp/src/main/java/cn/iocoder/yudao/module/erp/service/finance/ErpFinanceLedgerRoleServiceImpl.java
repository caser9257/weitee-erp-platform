...
import cn.iocoder.yudao.module.erp.dal.dataobject.finance.ErpFinanceLedgerRoleDO;
import cn.iocoder.yudao.module.erp.dal.mysql.finance.ErpFinanceLedgerRoleMapper;
...
public class ErpFinanceLedgerRoleServiceImpl implements ErpFinanceLedgerRoleService {
    ...
    public void deleteLedgerRole(Long ledgerId, Long roleId) {
        ledgerRoleMapper.delete(new cn.iocoder.yudao.framework.mybatis.core.query.LambdaQueryWrapperX<ErpFinanceLedgerRoleDO>()
