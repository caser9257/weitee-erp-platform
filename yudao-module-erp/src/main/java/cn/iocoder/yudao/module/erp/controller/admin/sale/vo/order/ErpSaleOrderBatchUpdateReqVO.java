...
@Schema(description = "管理后台 - ERP 销售订单批量修改 Request VO")
@Data
public class ErpSaleOrderBatchUpdateReqVO {

    @Schema(description = "销售订单编号列表", requiredMode = Schema.RequiredMode.REQUIRED, example = "[1,2]")
