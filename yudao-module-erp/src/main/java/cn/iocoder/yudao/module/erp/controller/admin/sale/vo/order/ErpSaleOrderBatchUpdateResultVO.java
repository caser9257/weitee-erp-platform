...
@Schema(description = "管理后台 - ERP 销售订单批量修改 Response VO")
@Data
public class ErpSaleOrderBatchUpdateResultVO {
    ...
    public static class FailedItemVO {
        ...
        @Schema(description = "失败原因", requiredMode = Schema.RequiredMode.REQUIRED, example = "当前销售订单不存在")
