...
@Schema(description = "管理后台 - ERP 采购订单批量修改 Request VO")
@Data
public class ErpPurchaseOrderBatchUpdateReqVO {

    @Schema(description = "采购订单编号列表", requiredMode = Schema.RequiredMode.REQUIRED, example = "[1,2]")
