...
import cn.iocoder.yudao.module.erp.service.finance.event.VoucherCreatedEvent;
...
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_ALREADY_EXISTS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_APPROVE_FAIL_STATUS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_CANCEL_APPROVE_FAIL_STATUS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_CANCEL_POST_FAIL_STATUS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_CANCEL_POST_REVERSE_NOT_ALLOWED;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_NOT_EXISTS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_POST_FAIL_STATUS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_REVERSE_ALREADY_EXISTS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_REVERSE_FAIL_STATUS;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_REVERSE_OF_REVERSE_NOT_ALLOWED;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_SOURCE_NOT_SUPPORTED;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_SOURCE_STATUS_INVALID;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_SOURCE_TIME_REQUIRED;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_TEMPLATE_BIZ_MISMATCH;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_TEMPLATE_LEDGER_MISMATCH;
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_UNBALANCED;
...
public class ErpFinanceVoucherServiceImpl implements ErpFinanceVoucherService {
    ...
    public Long recomputeAutoGeneratedVoucher(Integer bizType, Long bizId, Long userId, String remark) {
        ...
        rollbackAutoGeneratedVoucher(bizType, bizId, userId, remark);
        return autoGenerateVoucher(bizType, bizId);
    }
    ...
    private Long autoGenerateVoucherForLedger(Long ledgerId, Integer sourceBizType, Integer actualBizType, Long bizId) {
        ...
        if (ObjectUtil.equal(sourceBizType, ErpBizTypeEnum.RESEARCH_EXPENSE.getType())) {
            template = templates.stream()
                    ...
                    .filter(item -> !ObjectUtil.equal(item.getStatus(), cn.iocoder.yudao.framework.common.enums.CommonStatusEnum.DISABLE.getStatus()))
    ...
    private ErpFinancePeriodDO validateVoucherPeriodOpen(Long ledgerId, Long expectedPeriodId, LocalDateTime voucherTime) {
        ...
        if (expectedPeriodId != null && !ObjectUtil.equal(period.getId(), expectedPeriodId)) {
            throw exception(cn.iocoder.yudao.module.erp.enums.ErrorCodeConstantsFinanceLedger.FINANCE_PERIOD_CURRENT_OPEN_NOT_EXISTS,
