...
public class ErpNoRedisDAO {
    ...
    /**
     * 采购入库质检单 {@link cn.iocoder.yudao.module.erp.dal.dataobject.purchase.ErpPurchaseInQualityDO}
     */
    ...
    /**
     * 采购来源批次 {@link cn.iocoder.yudao.module.erp.dal.dataobject.purchase.ErpPurchaseSourceBatchDO}
     */
    public static final String PURCHASE_SOURCE_BATCH_NO_PREFIX = "CGLY";

    /**
     * MRP 计划 {@link cn.iocoder.yudao.module.erp.dal.dataobject.mrp.ErpMrpPlanDO}
     */
    public static final String MRP_PLAN_NO_PREFIX = "MRP";

    /**
     * 项目 {@link cn.iocoder.yudao.module.erp.dal.dataobject.project.ErpProjectDO}
     */
    public static final String PROJECT_NO_PREFIX = "XM";

    /**
     * 生产工单 {@link cn.iocoder.yudao.module.erp.dal.dataobject.mrp.ErpProductionOrderDO}
     */
    ...
    /**
     * 预付款单 {@link cn.iocoder.yudao.module.erp.dal.dataobject.finance.ErpFinancePrepaymentDO}
     */
