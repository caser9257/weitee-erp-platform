package cn.iocoder.yudao.module.erp.service.finance.interceptor;
...
public class FinanceDataPermissionInterceptor {
     ...
     * 拦截财务查询方法，自动注入数据权限过滤
     */
    @Around("@annotation(cn.iocoder.yudao.module.erp.service.finance.interceptor.FinanceDataPermission)")
