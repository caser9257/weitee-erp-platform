package cn.weitee.erp.framework.ratelimiter.config;

import cn.weitee.erp.framework.ratelimiter.core.aop.RateLimiterAspect;
import cn.weitee.erp.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import cn.weitee.erp.framework.ratelimiter.core.keyresolver.impl.*;
import cn.weitee.erp.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class WeiteeRateLimiterConfiguration {
