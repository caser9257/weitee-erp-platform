package cn.weitee.erp.framework.websocket.config;

import cn.weitee.erp.framework.mq.redis.config.WeiteeRedisMQConsumerAutoConfiguration;
import cn.weitee.erp.framework.mq.redis.core.RedisMQTemplate;
import cn.weitee.erp.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.weitee.erp.framework.websocket.core.listener.WebSocketMessageListener;
import cn.weitee.erp.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.weitee.erp.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.weitee.erp.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.weitee.erp.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.weitee.erp.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.weitee.erp.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.weitee.erp.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.weitee.erp.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.weitee.erp.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.weitee.erp.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.weitee.erp.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.weitee.erp.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.weitee.erp.framework.websocket.core.session.WebSocketSessionManager;
import cn.weitee.erp.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class WeiteeWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "weitee.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "weitee.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "weitee.websocket", name = "sender-type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "weitee.websocket", name = "sender-type", havingValue = "rabbitmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "weitee.websocket", name = "sender-type", havingValue = "kafka")
