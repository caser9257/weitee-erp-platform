package cn.weitee.erp.framework.tracer.config;

import cn.weitee.erp.framework.common.enums.WebFilterOrderEnum;
import cn.weitee.erp.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "weitee.tracer", value = "enable", matchIfMissing = true)
public class WeiteeTracerAutoConfiguration {
