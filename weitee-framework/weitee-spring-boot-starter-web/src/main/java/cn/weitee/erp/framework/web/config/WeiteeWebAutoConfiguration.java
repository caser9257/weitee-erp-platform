package cn.weitee.erp.framework.web.config;
...
import cn.weitee.erp.framework.web.core.filter.CacheRequestBodyFilter;
import cn.weitee.erp.framework.web.core.filter.DemoFilter;
import cn.weitee.erp.framework.web.core.handler.GlobalExceptionHandler;
import cn.weitee.erp.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class WeiteeWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "weitee.demo", havingValue = "true")
