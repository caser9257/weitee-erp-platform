...
import cn.weitee.erp.framework.common.util.collection.SetUtils;
...
public class GlobalExceptionHandler {
    ...
    private CommonResult<?> handleTableNotExists(Throwable ex) {
        ...
        if (message.contains("report_")) {
            log.error("[报表模块 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[报表模块 - 表结构未导入][请联系管理员开启]");
        }
        // 2. 工作流
        if (message.contains("bpm_")) {
            log.error("[工作流模块 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[工作流模块 - 表结构未导入][请联系管理员开启]");
        }
        // 4. 商城系统
        if (StrUtil.containsAny(message, "product_", "promotion_", "trade_")) {
            log.error("[商城系统 - 已禁用][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[商城系统 - 已禁用][请联系管理员开启]");
        }
        // 5. ERP 系统
        if (message.contains("erp_")) {
            log.error("[ERP 系统 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[ERP 系统 - 表结构未导入][请联系管理员开启]");
        }
        // 6. WMS 仓库管理系统
        if (message.contains("wms_")) {
            log.error("[WMS 仓库管理系统 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[WMS 仓库管理系统 - 表结构未导入][请联系管理员开启]");
        }
        // 7. CRM 系统
        if (message.contains("crm_")) {
            log.error("[CRM 系统 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[CRM 系统 - 表结构未导入][请联系管理员开启]");
        }
        // 8. MES 系统
        if (message.contains("mes_")) {
            log.error("[MES 系统 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[MES 系统 - 表结构未导入][请联系管理员开启]");
        }
        // 9. IM 即时通讯
        if (message.contains("im_")) {
            log.error("[IM 即时通讯 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[IM 即时通讯 - 表结构未导入][请联系管理员开启]");
        }
        // 10. 支付平台
        if (message.contains("pay_")) {
            log.error("[支付模块 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[支付模块 - 表结构未导入][请联系管理员开启]");
        }
        // 11. AI 大模型
        if (message.contains("ai_")) {
            log.error("[AI 大模型 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[AI 大模型 - 表结构未导入][请联系管理员开启]");
        }
        // 12. IoT 物联网
        if (message.contains("iot_")) {
            log.error("[IoT 物联网 - 表结构未导入][请联系管理员开启]");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[IoT 物联网 - 表结构未导入][请联系管理员开启]");
        }
        return null;
    }
