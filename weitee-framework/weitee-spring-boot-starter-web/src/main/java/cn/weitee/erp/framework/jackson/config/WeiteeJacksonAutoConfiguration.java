package cn.weitee.erp.framework.jackson.config;

import cn.weitee.erp.framework.common.util.json.JsonUtils;
import cn.weitee.erp.framework.common.util.json.databind.NumberSerializer;
import cn.weitee.erp.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.weitee.erp.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class WeiteeJacksonAutoConfiguration {
