package cn.weitee.erp.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.weitee.erp.framework.common.util.json.JsonUtils;
import cn.weitee.erp.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${weitee.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class WeiteeMybatisAutoConfiguration {

    static {
        // 动态 SQL 智能优化支持本地缓存加速解析，更完善的复杂 XML 动态 SQL 支持，静态注入缓存
