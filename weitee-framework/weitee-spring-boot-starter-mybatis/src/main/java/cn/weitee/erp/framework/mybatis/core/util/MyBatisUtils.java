package cn.weitee.erp.framework.mybatis.core.util;
...
import cn.weitee.erp.framework.common.pojo.SortingField;
import cn.weitee.erp.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://gitee.com/zhijiantianya/weitee-cloud/issues/ID2QLL
        // 排序字段
