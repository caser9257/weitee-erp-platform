package cn.weitee.erp.framework.quartz.core.scheduler;

import cn.weitee.erp.framework.quartz.core.enums.JobDataKeyEnum;
import cn.weitee.erp.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;

import static cn.weitee.erp.framework.common.exception.enums.GlobalErrorCodeConstants.NOT_IMPLEMENTED;
