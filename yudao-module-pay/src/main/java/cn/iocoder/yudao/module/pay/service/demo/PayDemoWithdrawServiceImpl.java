...
public class PayDemoWithdrawServiceImpl implements PayDemoWithdrawService {
    ...
    @Resource
    private PayDemoWithdrawMapper payDemoWithdrawMapper;
    ...
    public Long transferDemoWithdraw(Long id, Long userId) {
        ...
        if (PayDemoWithdrawStatusEnum.isClosed(withdraw.getStatus())) {
            int updateCount = payDemoWithdrawMapper.updateByIdAndStatus(withdraw.getId(), withdraw.getStatus(),
        ...
        payDemoWithdrawMapper.updateByIdAndStatus(withdraw.getId(), withdraw.getStatus(),
    ...
    private PayDemoWithdrawDO validateDemoWithdrawCanTransfer(Long id) {
        // 校验存在
        PayDemoWithdrawDO withdraw = payDemoWithdrawMapper.selectById(id);
        if (withdraw == null) {
    ...
    public PageResult<PayDemoWithdrawDO> getDemoWithdrawPage(PageParam pageVO) {
        return payDemoWithdrawMapper.selectPage(pageVO);
    }
