...
import cn.weitee.erp.module.infra.dal.mysql.file.FileBizRelMapper;
...
public class FileBizRelServiceImpl implements FileBizRelService {
    ...
    public void deleteFileBizRel(Long fileId, String bizType, Long bizId) {
        fileBizRelMapper.delete(new cn.weitee.erp.framework.mybatis.core.query.LambdaQueryWrapperX<FileBizRelDO>()
