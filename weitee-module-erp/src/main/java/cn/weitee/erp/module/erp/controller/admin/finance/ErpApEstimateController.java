...
import cn.weitee.erp.module.erp.controller.admin.finance.vo.apestimate.ErpApEstimateTraceRespVO;
...
import cn.weitee.erp.module.erp.enums.ErpApEstimateClosureStatusEnum;
...
import cn.weitee.erp.module.erp.service.finance.ErpApEstimateService;
...
public class ErpApEstimateController {
    ...
    private Map<Long, ErpApStatementDO> buildStatementMap(List<ErpApEstimateDO> estimates) {
        ...
        return apStatementService.getApStatementListByBizTypeAndBizIds(
                cn.weitee.erp.module.erp.enums.common.ErpBizTypeEnum.PURCHASE_IN.getType(), bizIds)
                .stream()
