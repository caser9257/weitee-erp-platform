package cn.weitee.erp.module.erp.controller.admin.purchase.vo.supplier;
...
@Schema(description = "管理后台 - ERP 供应商批量修改 Response VO")
@Data
public class ErpSupplierBatchUpdateResultVO {
    ...
    public static class FailedItemVO {
        ...
        @Schema(description = "失败原因", requiredMode = Schema.RequiredMode.REQUIRED, example = "供应商不存在")
