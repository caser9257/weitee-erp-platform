...
public class FinanceDataPermissionInterceptor {
    ...
    @Around("@annotation(cn.weitee.erp.module.erp.service.finance.interceptor.FinanceDataPermission) || "
            + "@within(cn.weitee.erp.module.erp.service.finance.interceptor.FinanceDataPermission)")
    public Object around(ProceedingJoinPoint point) throws Throwable {
        FinanceDataPermissionContext.setPermissionScope(financeDataPermissionService.getPermissionScope());
