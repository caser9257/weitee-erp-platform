...
import cn.weitee.erp.module.erp.controller.admin.sale.vo.returns.ErpSaleReturnPageReqVO;
import cn.weitee.erp.module.erp.controller.admin.sale.vo.returns.ErpSaleReturnSaveReqVO;
...
public class ErpSaleReturnServiceImpl implements ErpSaleReturnService {
    ...
    @Resource
    private ErpSaleReturnItemMapper erpSaleReturnItemMapper;
    ...
    public Long createSaleReturn(ErpSaleReturnSaveReqVO createReqVO) {
        ...
        erpSaleReturnMapper.insert(saleReturn);
        // 2.2 插入退货项
        saleReturnItems.forEach(o -> o.setReturnId(saleReturn.getId()));
        erpSaleReturnItemMapper.insertBatch(saleReturnItems);
    ...
    public void updateSaleReturn(ErpSaleReturnSaveReqVO updateReqVO) {
        ...
        erpSaleReturnMapper.updateById(updateObj);
        // 2.2 更新退货项
    ...
    private void updateSaleOrderReturnCount(Long orderId) {
        ...
        List<ErpSaleReturnDO> saleReturns = erpSaleReturnMapper.selectListByOrderId(orderId);
        // 1.2 查询对应的销售订单项的退货数量
        Map<Long, BigDecimal> returnCountMap = erpSaleReturnItemMapper.selectOrderItemCountSumMapByReturnIds(
    ...
    public void updateSaleReturnRefundPrice(Long id, BigDecimal refundPrice) {
        ErpSaleReturnDO saleReturn = erpSaleReturnMapper.selectById(id);
        ...
        erpSaleReturnMapper.updateById(new ErpSaleReturnDO().setId(id).setRefundPrice(refundPrice));
    }
    ...
    private void updateSaleReturnItemList(Long id, List<ErpSaleReturnItemDO> newList) {
        ...
        List<ErpSaleReturnItemDO> oldList = erpSaleReturnItemMapper.selectListByReturnId(id);
        ...
        if (CollUtil.isNotEmpty(diffList.get(0))) {
            ...
            erpSaleReturnItemMapper.insertBatch(diffList.get(0));
        }
        if (CollUtil.isNotEmpty(diffList.get(1))) {
            erpSaleReturnItemMapper.updateBatch(diffList.get(1));
        }
        if (CollUtil.isNotEmpty(diffList.get(2))) {
            erpSaleReturnItemMapper.deleteByIds(convertList(diffList.get(2), ErpSaleReturnItemDO::getId));
        }
    }
    ...
    public void deleteSaleReturn(List<Long> ids) {
        // 1. 校验不处于已审批
        List<ErpSaleReturnDO> saleReturns = erpSaleReturnMapper.selectByIds(ids);
        ...
        saleReturns.forEach(saleReturn -> {
            // 2.1 删除订单
            erpSaleReturnMapper.deleteById(saleReturn.getId());
            // 2.2 删除订单项
            erpSaleReturnItemMapper.deleteByReturnId(saleReturn.getId());
    ...
    public ErpSaleReturnDO getSaleReturn(Long id) {
        return erpSaleReturnMapper.selectById(id);
    }
    ...
    public PageResult<ErpSaleReturnDO> getSaleReturnPage(ErpSaleReturnPageReqVO pageReqVO) {
        return erpSaleReturnMapper.selectPage(pageReqVO);
    }
    ...
    public List<ErpSaleReturnItemDO> getSaleReturnItemListByReturnId(Long returnId) {
        return erpSaleReturnItemMapper.selectListByReturnId(returnId);
    }
    ...
    public List<ErpSaleReturnItemDO> getSaleReturnItemListByReturnIds(Collection<Long> returnIds) {
        ...
        return erpSaleReturnItemMapper.selectListByReturnIds(returnIds);
    }
