...
import cn.weitee.erp.module.erp.controller.admin.stock.vo.stock.ErpStockRespVO;
...
public class ErpStockController {
    ...
    private PageResult<ErpStockRespVO> buildStockVOPageResult(PageResult<ErpStockDO> pageResult) {
        ...
        Map<Long, ErpWarehouseCategoryDO> warehouseCategoryMap = warehouseCategoryService.getWarehouseCategoryMap(
                convertSet(warehouseMap.values(), ErpWarehouseDO::getCategoryId));
