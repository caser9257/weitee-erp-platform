...
import cn.weitee.erp.module.erp.controller.admin.sale.vo.returns.ErpSaleReturnRespVO;
...
public class ErpSaleReturnController {
    ...
    private PageResult<ErpSaleReturnRespVO> buildSaleReturnVOPageResult(PageResult<ErpSaleReturnDO> pageResult) {
        ...
        Map<Long, AdminUserRespDTO> userMap = adminUserApi.getUserMap(
                convertSet(pageResult.getList(), saleReturn -> parseUserId(saleReturn.getCreator())));
        // 2. 开始拼接
        return BeanUtils.toBean(pageResult, ErpSaleReturnRespVO.class, saleReturn -> {
            ...
            MapUtils.findAndThen(userMap, parseUserId(saleReturn.getCreator()), user -> saleReturn.setCreatorName(user.getNickname()));
        });
    }
