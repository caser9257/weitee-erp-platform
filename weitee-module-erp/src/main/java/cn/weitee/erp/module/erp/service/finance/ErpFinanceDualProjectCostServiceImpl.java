...
import cn.weitee.erp.module.erp.dal.dataobject.finance.ErpFinanceDualProjectCostItemDO;
import cn.weitee.erp.module.erp.dal.dataobject.finance.ErpFinanceDualProjectCostRebuildLogDO;
...
import cn.weitee.erp.module.erp.dal.mysql.finance.ErpFinanceDualProjectCostResultMapper;
import cn.weitee.erp.module.erp.dal.mysql.finance.ErpFinanceDualProjectCostItemMapper;
import cn.weitee.erp.module.erp.dal.mysql.finance.ErpFinanceDualProjectCostRebuildLogMapper;
...
public class ErpFinanceDualProjectCostServiceImpl implements ErpFinanceDualProjectCostService {
    ...
    private void writeProjectCostExcel(List<ErpFinanceDualProjectCostResultDO> list, String ledgerLabel,
        ...
        try (cn.idev.excel.ExcelWriter writer = cn.idev.excel.FastExcel.write(response.getOutputStream()).build()) {
            cn.idev.excel.write.metadata.WriteSheet sheet = cn.idev.excel.FastExcel.writerSheet("项目成本").build();
