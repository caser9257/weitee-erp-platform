...
@Schema(description = "管理后台 - ERP 仓库批量修改 Response VO")
@Data
public class ErpWarehouseBatchUpdateResultVO {
    ...
    public static class FailedItemVO {
        ...
        @Schema(description = "失败原因", requiredMode = Schema.RequiredMode.REQUIRED, example = "仓库不存在")
