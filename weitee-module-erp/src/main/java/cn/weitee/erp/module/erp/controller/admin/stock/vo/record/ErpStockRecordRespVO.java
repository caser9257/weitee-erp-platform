package cn.weitee.erp.module.erp.controller.admin.stock.vo.record;
...
import cn.weitee.erp.module.erp.enums.DictTypeConstants;
...
public class ErpStockRecordRespVO {
    ...
    @Schema(description = "仓库分类名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "原料仓")
    @ExcelProperty("仓库分类名称")
