...
public class ErpFinanceDualWriteServiceImpl implements ErpFinanceDualWriteService {
    ...
    private Long generateTargetVoucher(ErpFinanceVoucherDO sourceVoucher, List<ErpFinanceVoucherEntryDO> entries,
        ...
        // 获取目标账簿的默认模板
        cn.weitee.erp.module.erp.controller.admin.finance.vo.voucher.ErpFinanceVoucherGenerateReqVO reqVO =
                new cn.weitee.erp.module.erp.controller.admin.finance.vo.voucher.ErpFinanceVoucherGenerateReqVO();
    ...
    public void retryDualWrite(Long logId) {
        ...
        if (sourceVoucher == null) {
            throw exception(cn.weitee.erp.module.erp.enums.ErrorCodeConstantsFinanceVoucher.FINANCE_VOUCHER_NOT_EXISTS);
        }
    ...
    public int recomputeDualLedgerVouchers(Integer bizType) {
        ...
        List<ErpFinanceDualWriteLogDO> logs = dualWriteLogMapper.selectList(
                new cn.weitee.erp.framework.mybatis.core.query.LambdaQueryWrapperX<ErpFinanceDualWriteLogDO>()
