...
import cn.weitee.erp.module.erp.controller.admin.purchase.vo.supplier.ErpSupplierRespVO;
...
public class ErpSupplierController {
    ...
    @Operation(summary = "批量更新供应商")
    @PreAuthorize("@ss.hasPermission('erp:supplier:update')")
    public CommonResult<ErpSupplierBatchUpdateResultVO> updateSupplierBatch(
            @Valid @RequestBody ErpSupplierBatchUpdateReqVO reqVO) {
        return success(supplierService.updateSupplierBatch(reqVO));
    }
