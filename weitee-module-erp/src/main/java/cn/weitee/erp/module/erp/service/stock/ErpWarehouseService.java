...
public interface ErpWarehouseService {
     ...
     * @return 批量更新结果
     */
    ErpWarehouseBatchUpdateResultVO updateWarehouseBatch(@Valid ErpWarehouseBatchUpdateReqVO reqVO);
     ...
     * 获得指定分类的仓库列表
     */
    List<ErpWarehouseDO> getWarehouseListByCategoryId(Long categoryId);
