...
import static cn.weitee.erp.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockMoveRespVO {
    ...
    public static class Item {
        ...
        @Schema(description = "产品单位编号（录入单位）", example = "3113")
        ...
        @Schema(description = "合计金额，单位：元", requiredMode = Schema.RequiredMode.REQUIRED, example = "100.00")
        private BigDecimal totalPrice;
        ...
        @Schema(description = "调出仓库名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "一号仓库")
        private String fromWarehouseName;

        @Schema(description = "调入仓库名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "二号仓库")
