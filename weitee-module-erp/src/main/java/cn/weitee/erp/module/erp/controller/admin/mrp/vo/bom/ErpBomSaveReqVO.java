...
public class ErpBomSaveReqVO {
    ...
    @Schema(description = "BOM 编号", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotEmpty(message = "BOM 编号不能为空")
    ...
    public static class Item {
        ...
        @Schema(description = "物料类型，0-采购，1-自制")
        ...
        @Schema(description = "渚涙枡褰掑睘锛圕OMPANY/CUSTOMER/OUTSOURCE锛?")
