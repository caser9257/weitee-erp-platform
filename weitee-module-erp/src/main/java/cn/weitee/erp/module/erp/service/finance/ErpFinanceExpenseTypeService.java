...
import cn.weitee.erp.module.erp.controller.admin.finance.vo.expense.ExpenseTypeVO;
...
import static cn.weitee.erp.module.erp.enums.ErrorCodeConstantsExpense.*;
...
public class ErpFinanceExpenseTypeService {
    ...
    public void validateExpenseType(Integer expenseType, Integer projectId, Long costCenterId, String leaseContractNo) {
        ...
        if (typeConfig.isCostCenterRequired()) {
            ...
            // 校验部门的 cost_type 已配置
            cn.weitee.erp.module.system.api.dept.dto.DeptRespDTO dept = deptApi.getDept(costCenterId);
            if (dept == null) {
                throw exception(EXPENSE_COST_CENTER_REQUIRED);
            }
        }
