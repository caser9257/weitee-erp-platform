...
class ErpBomItemSubstituteServiceImplTest {
    ...
    void setUp() throws Exception {
        ...
        setField(service, "productService", createProxy(ErpProductService.class, (methodName, args) -> {
            if ("getProductVOMap".equals(methodName)) {
                return Map.of(
                        201L, new cn.weitee.erp.module.erp.controller.admin.product.vo.product.ErpProductRespVO()
                                .setId(201L).setName("成品A"),
                        301L, new cn.weitee.erp.module.erp.controller.admin.product.vo.product.ErpProductRespVO()
                                .setId(301L).setName("替代料A"),
                        401L, new cn.weitee.erp.module.erp.controller.admin.product.vo.product.ErpProductRespVO()
    ...
    private String mapFieldName(String fieldName) {
        if ("substituteMapper".equals(fieldName)) {
            return "erpBomItemSubstituteMapper";
        }
