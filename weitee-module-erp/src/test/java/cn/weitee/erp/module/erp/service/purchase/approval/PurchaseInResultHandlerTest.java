...
class PurchaseInResultHandlerTest {
    ...
    private Object createServiceProxy(Long entityId, AtomicReference<Long> idRef,
        ...
        return createProxy(ErpPurchaseInService.class, (methodName, args) -> {
            if ("getPurchaseIn".equals(methodName)) {
                return entityId == null ? null : new cn.weitee.erp.module.erp.dal.dataobject.purchase.ErpPurchaseInDO().setId(entityId);
            }
            ...
            if ("rollbackPurchaseInStatusToDraftByBpm".equals(methodName)) {
