...
class ErpSaleOrderBpmStatusListenerTest {
    ...
    void onApplicationEvent_shouldRouteMatchingSaleOrderEvent() throws Exception {
        ...
        setField(listener, "saleOrderBpmService", createProxyByName("cn.weitee.erp.module.erp.service.sale.ErpSaleOrderBpmService",
                (methodName, args) -> {
    ...
    private Object instantiateListener() throws Exception {
        Class<?> clazz = Class.forName("cn.weitee.erp.module.erp.service.sale.listener.ErpSaleOrderBpmStatusListener");
