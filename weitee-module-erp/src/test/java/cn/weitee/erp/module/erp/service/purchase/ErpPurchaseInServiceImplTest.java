...
class ErpPurchaseInServiceImplTest {
    ...
    private cn.weitee.erp.module.erp.service.product.ErpProductService createProductServiceProxy() {
        return createProxy(cn.weitee.erp.module.erp.service.product.ErpProductService.class, (methodName, args) -> {
    ...
    private cn.weitee.erp.module.erp.service.finance.ErpAccountService createAccountServiceProxy() {
        return createProxy(cn.weitee.erp.module.erp.service.finance.ErpAccountService.class, (methodName, args) -> {
