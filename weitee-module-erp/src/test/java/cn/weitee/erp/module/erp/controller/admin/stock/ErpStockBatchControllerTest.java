...
class ErpStockBatchControllerTest {
    ...
    void buildStockBatchVOPageResult_shouldKeepPageOrderAndEnrichBatchFields() throws Exception {
        ...
        var method = ErpStockBatchController.class.getDeclaredMethod("buildStockBatchVOPageResult", cn.weitee.erp.framework.common.pojo.PageResult.class);
        method.setAccessible(true);
        @SuppressWarnings("unchecked")
        cn.weitee.erp.framework.common.pojo.PageResult<ErpStockBatchRespVO> result =
                (cn.weitee.erp.framework.common.pojo.PageResult<ErpStockBatchRespVO>) method.invoke(controller,
                        new cn.weitee.erp.framework.common.pojo.PageResult<>(pageRef.get(), 3L));
