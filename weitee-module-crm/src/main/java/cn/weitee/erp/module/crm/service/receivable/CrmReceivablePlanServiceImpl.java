...
import cn.weitee.erp.module.crm.controller.admin.receivable.vo.plan.CrmReceivablePlanPageReqVO;
import cn.weitee.erp.module.crm.controller.admin.receivable.vo.plan.CrmReceivablePlanSaveReqVO;
...
import cn.weitee.erp.module.crm.dal.mysql.receivable.CrmReceivablePlanMapper;
...
import static cn.weitee.erp.module.crm.enums.ErrorCodeConstants.RECEIVABLE_PLAN_NOT_EXISTS;
import static cn.weitee.erp.module.crm.enums.ErrorCodeConstants.RECEIVABLE_PLAN_UPDATE_FAIL;
...
public class CrmReceivablePlanServiceImpl implements CrmReceivablePlanService {
    ...
    public Long createReceivablePlan(CrmReceivablePlanSaveReqVO createReqVO) {
        ...
        // 2. 插入回款计划
        CrmReceivablePlanDO maxPeriodReceivablePlan = crmReceivablePlanMapper.selectMaxPeriodByContractId(createReqVO.getContractId());
    ...
    public void updateReceivablePlanReceivableId(Long id, Long receivableId) {
        ...
        // 更新回款计划
        crmReceivablePlanMapper.updateById(new CrmReceivablePlanDO().setId(id).setReceivableId(receivableId));
    }
    ...
    private CrmReceivablePlanDO validateReceivablePlanExists(Long id) {
        CrmReceivablePlanDO receivablePlan = crmReceivablePlanMapper.selectById(id);
    ...
    public PageResult<CrmReceivablePlanDO> getReceivablePlanPageByCustomerId(CrmReceivablePlanPageReqVO pageReqVO) {
        return crmReceivablePlanMapper.selectPageByCustomerId(pageReqVO);
    }

    @Override
    public Long getReceivablePlanRemindCount(Long userId) {
        return crmReceivablePlanMapper.selectReceivablePlanCountByRemind(userId);
    }
