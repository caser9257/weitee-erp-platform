package cn.weitee.erp.module.crm.service.receivable;
...
import cn.weitee.erp.module.crm.controller.admin.receivable.vo.receivable.CrmReceivablePageReqVO;
import cn.weitee.erp.module.crm.controller.admin.receivable.vo.receivable.CrmReceivableSaveReqVO;
import cn.weitee.erp.module.crm.dal.dataobject.contract.CrmContractDO;
import cn.weitee.erp.module.crm.dal.dataobject.receivable.CrmReceivableDO;
import cn.weitee.erp.module.crm.dal.dataobject.receivable.CrmReceivablePlanDO;
import cn.weitee.erp.module.crm.dal.mysql.receivable.CrmReceivableMapper;
...
public class CrmReceivableServiceImpl implements CrmReceivableService {
    ...
    public Long createReceivable(CrmReceivableSaveReqVO createReqVO) {
        ...
        if (crmReceivableMapper.selectByNo(no) != null) {
    ...
    private void validateReceivablePriceExceedsLimit(CrmReceivableSaveReqVO reqVO) {
        ...
        List<CrmReceivableDO> receivables = crmReceivableMapper.selectListByContractIdAndStatus(reqVO.getContractId(),
    ...
    public void updateReceivableAuditStatus(Long id, Integer bpmResult) {
        ...
        crmReceivableMapper.updateById(new CrmReceivableDO().setId(id).setAuditStatus(auditStatus));
    }
    ...
    public void submitReceivable(Long id, Long userId) {
        ...
        // 3. 更新回款工作流编号
        crmReceivableMapper.updateById(new CrmReceivableDO().setId(id).setProcessInstanceId(processInstanceId)
    ...
    private CrmReceivableDO validateReceivableExists(Long id) {
        CrmReceivableDO receivable = crmReceivableMapper.selectById(id);
        if (receivable == null) {
