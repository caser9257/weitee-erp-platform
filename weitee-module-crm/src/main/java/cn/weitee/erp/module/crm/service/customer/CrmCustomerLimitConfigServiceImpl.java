...
import cn.weitee.erp.module.crm.controller.admin.customer.vo.limitconfig.CrmCustomerLimitConfigPageReqVO;
import cn.weitee.erp.module.crm.controller.admin.customer.vo.limitconfig.CrmCustomerLimitConfigSaveReqVO;
import cn.weitee.erp.module.crm.dal.dataobject.customer.CrmCustomerLimitConfigDO;
import cn.weitee.erp.module.crm.dal.mysql.customer.CrmCustomerLimitConfigMapper;
import cn.weitee.erp.module.crm.enums.customer.CrmCustomerLimitConfigTypeEnum;
...
import static cn.weitee.erp.module.crm.enums.ErrorCodeConstants.CUSTOMER_LIMIT_CONFIG_NOT_EXISTS;
...
public class CrmCustomerLimitConfigServiceImpl implements CrmCustomerLimitConfigService {
    ...
    public Long createCustomerLimitConfig(CrmCustomerLimitConfigSaveReqVO createReqVO) {
        ...
        crmCustomerLimitConfigMapper.insert(limitConfig);
    ...
    public void updateCustomerLimitConfig(CrmCustomerLimitConfigSaveReqVO updateReqVO) {
        ...
        crmCustomerLimitConfigMapper.updateById(updateObj);
    ...
    public void deleteCustomerLimitConfig(Long id) {
        ...
        // 删除
        crmCustomerLimitConfigMapper.deleteById(id);
    ...
    public CrmCustomerLimitConfigDO getCustomerLimitConfig(Long id) {
        return crmCustomerLimitConfigMapper.selectById(id);
    }

    @Override
    public PageResult<CrmCustomerLimitConfigDO> getCustomerLimitConfigPage(CrmCustomerLimitConfigPageReqVO pageReqVO) {
        return crmCustomerLimitConfigMapper.selectPage(pageReqVO);
    }

    private CrmCustomerLimitConfigDO validateCustomerLimitConfigExists(Long id) {
        CrmCustomerLimitConfigDO limitConfigDO = crmCustomerLimitConfigMapper.selectById(id);
    ...
    public List<CrmCustomerLimitConfigDO> getCustomerLimitConfigListByUserId(Integer type, Long userId) {
        ...
        return crmCustomerLimitConfigMapper.selectListByTypeAndUserIdAndDeptId(type, userId, user.getDeptId());
    }
