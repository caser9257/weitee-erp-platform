package cn.weitee.erp.module.crm.service.statistics;
...
import cn.weitee.erp.framework.ip.core.Area;
import cn.weitee.erp.framework.ip.core.enums.AreaTypeEnum;
import cn.weitee.erp.framework.ip.core.utils.AreaUtils;
import cn.weitee.erp.module.crm.controller.admin.statistics.vo.customer.*;
import cn.weitee.erp.module.crm.dal.mysql.statistics.CrmStatisticsCustomerMapper;
...
import static cn.weitee.erp.framework.common.util.collection.MapUtils.findAndThen;
...
public class CrmStatisticsCustomerServiceImpl implements CrmStatisticsCustomerService {
    ...
    @Resource
    private CrmStatisticsCustomerMapper crmStatisticsCustomerMapper;
    ...
    public List<CrmStatisticsCustomerSummaryByDateRespVO> getCustomerSummaryByDate(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按天统计，获取分项统计数据
        List<CrmStatisticsCustomerSummaryByDateRespVO> customerCreateCountList = crmStatisticsCustomerMapper.selectCustomerCreateCountGroupByDate(reqVO);
        List<CrmStatisticsCustomerSummaryByDateRespVO> customerDealCountList = crmStatisticsCustomerMapper.selectCustomerDealCountGroupByDate(reqVO);
    ...
    public List<CrmStatisticsCustomerSummaryByUserRespVO> getCustomerSummaryByUser(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按用户统计，获取分项统计数据
        List<CrmStatisticsCustomerSummaryByUserRespVO> customerCreateCountList = crmStatisticsCustomerMapper.selectCustomerCreateCountGroupByUser(reqVO);
        List<CrmStatisticsCustomerSummaryByUserRespVO> customerDealCountList = crmStatisticsCustomerMapper.selectCustomerDealCountGroupByUser(reqVO);
        List<CrmStatisticsCustomerSummaryByUserRespVO> contractPriceList = crmStatisticsCustomerMapper.selectContractPriceGroupByUser(reqVO);
        List<CrmStatisticsCustomerSummaryByUserRespVO> receivablePriceList = crmStatisticsCustomerMapper.selectReceivablePriceGroupByUser(reqVO);
    ...
    public List<CrmStatisticsFollowUpSummaryByDateRespVO> getFollowUpSummaryByDate(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按天统计，获取分项统计数据
        List<CrmStatisticsFollowUpSummaryByDateRespVO> followUpRecordCountList = crmStatisticsCustomerMapper.selectFollowUpRecordCountGroupByDate(reqVO);
        List<CrmStatisticsFollowUpSummaryByDateRespVO> followUpCustomerCountList = crmStatisticsCustomerMapper.selectFollowUpCustomerCountGroupByDate(reqVO);
    ...
    public List<CrmStatisticsFollowUpSummaryByUserRespVO> getFollowUpSummaryByUser(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按用户统计，获取分项统计数据
        List<CrmStatisticsFollowUpSummaryByUserRespVO> followUpRecordCountList = crmStatisticsCustomerMapper.selectFollowUpRecordCountGroupByUser(reqVO);
        List<CrmStatisticsFollowUpSummaryByUserRespVO> followUpCustomerCountList = crmStatisticsCustomerMapper.selectFollowUpCustomerCountGroupByUser(reqVO);
    ...
    public List<CrmStatisticsFollowUpSummaryByTypeRespVO> getFollowUpSummaryByType(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 获得跟进数据
        return crmStatisticsCustomerMapper.selectFollowUpRecordCountGroupByType(reqVO);
    }
    ...
    public List<CrmStatisticsCustomerContractSummaryRespVO> getContractSummary(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按用户统计，获取统计数据
        List<CrmStatisticsCustomerContractSummaryRespVO> summaryList = crmStatisticsCustomerMapper.selectContractSummary(reqVO);
    ...
    public List<CrmStatisticsPoolSummaryByDateRespVO> getPoolSummaryByDate(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按天统计，获取分项统计数据
        List<CrmStatisticsPoolSummaryByDateRespVO> customerPutCountList = crmStatisticsCustomerMapper.selectPoolCustomerPutCountByDate(reqVO);
        List<CrmStatisticsPoolSummaryByDateRespVO> customerTakeCountList = crmStatisticsCustomerMapper.selectPoolCustomerTakeCountByDate(reqVO);
    ...
    public List<CrmStatisticsPoolSummaryByUserRespVO> getPoolSummaryByUser(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按用户统计，获取分项统计数据
        List<CrmStatisticsPoolSummaryByUserRespVO> customerPutCountList = crmStatisticsCustomerMapper.selectPoolCustomerPutCountByUser(reqVO);
        List<CrmStatisticsPoolSummaryByUserRespVO> customerTakeCountList = crmStatisticsCustomerMapper.selectPoolCustomerTakeCountByUser(reqVO);
    ...
    public List<CrmStatisticsCustomerDealCycleByDateRespVO> getCustomerDealCycleByDate(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按天统计，获取分项统计数据
        List<CrmStatisticsCustomerDealCycleByDateRespVO> customerDealCycleList = crmStatisticsCustomerMapper.selectCustomerDealCycleGroupByDate(reqVO);
    ...
    public List<CrmStatisticsCustomerDealCycleByUserRespVO> getCustomerDealCycleByUser(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 按用户统计，获取分项统计数据
        List<CrmStatisticsCustomerDealCycleByUserRespVO> customerDealCycleList = crmStatisticsCustomerMapper.selectCustomerDealCycleGroupByUser(reqVO);
        List<CrmStatisticsCustomerSummaryByUserRespVO> customerDealCountList = crmStatisticsCustomerMapper.selectCustomerDealCountGroupByUser(reqVO);
    ...
    public List<CrmStatisticsCustomerDealCycleByAreaRespVO> getCustomerDealCycleByArea(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 获取客户地区统计数据
        List<CrmStatisticsCustomerDealCycleByAreaRespVO> dealCycleByAreaList = crmStatisticsCustomerMapper.selectCustomerDealCycleGroupByAreaId(reqVO);
    ...
    public List<CrmStatisticsCustomerDealCycleByProductRespVO> getCustomerDealCycleByProduct(CrmStatisticsCustomerReqVO reqVO) {
        ...
        // 2. 获取客户产品统计数据
        // TODO @dhb52：未读取产品名
        return crmStatisticsCustomerMapper.selectCustomerDealCycleGroupByProductId(reqVO);
    }
