...
import cn.weitee.erp.module.crm.controller.admin.product.vo.category.CrmProductCategoryCreateReqVO;
import cn.weitee.erp.module.crm.controller.admin.product.vo.category.CrmProductCategoryListReqVO;
import cn.weitee.erp.module.crm.dal.dataobject.product.CrmProductCategoryDO;
import cn.weitee.erp.module.crm.dal.mysql.product.CrmProductCategoryMapper;
...
import static cn.weitee.erp.module.crm.dal.dataobject.product.CrmProductCategoryDO.PARENT_ID_NULL;
...
public class CrmProductCategoryServiceImpl implements CrmProductCategoryService {
    ...
    public Long createProductCategory(CrmProductCategoryCreateReqVO createReqVO) {
        ...
        crmProductCategoryMapper.insert(category);
    ...
    public void updateProductCategory(CrmProductCategoryCreateReqVO updateReqVO) {
        ...
        crmProductCategoryMapper.updateById(updateObj);
    }

    private void validateProductCategoryExists(Long id) {
        if (crmProductCategoryMapper.selectById(id) == null) {
    ...
    private void validateParentProductCategory(Long id) {
        ...
        // 父分类不存在
        CrmProductCategoryDO category = crmProductCategoryMapper.selectById(id);
        if (category == null) {
    ...
    private void validateProductNameExists(Long id, Long parentId, String name) {
        CrmProductCategoryDO category = crmProductCategoryMapper.selectByParentIdAndName(parentId, name);
        if (category == null
    ...
    public void deleteProductCategory(Long id) {
        ...
        // 1.2 校验是否还有子分类
        if (crmProductCategoryMapper.selectCountByParentId(id) > 0) {
