package cn.weitee.erp.module.crm.service.business;
...
import cn.weitee.erp.module.crm.controller.admin.business.vo.business.CrmBusinessPageReqVO;
import cn.weitee.erp.module.crm.controller.admin.business.vo.business.CrmBusinessSaveReqVO;
import cn.weitee.erp.module.crm.controller.admin.business.vo.business.CrmBusinessTransferReqVO;
import cn.weitee.erp.module.crm.controller.admin.business.vo.business.CrmBusinessUpdateStatusReqVO;
import cn.weitee.erp.module.crm.controller.admin.contact.vo.CrmContactBusinessReqVO;
import cn.weitee.erp.module.crm.controller.admin.statistics.vo.funnel.CrmStatisticsFunnelReqVO;
...
import cn.weitee.erp.module.crm.dal.dataobject.business.CrmBusinessStatusDO;
import cn.weitee.erp.module.crm.dal.dataobject.contact.CrmContactBusinessDO;
import cn.weitee.erp.module.crm.dal.mysql.business.CrmBusinessMapper;
import cn.weitee.erp.module.crm.dal.mysql.business.CrmBusinessProductMapper;
...
import cn.weitee.erp.module.crm.service.contact.CrmContactBusinessService;
...
import cn.weitee.erp.module.crm.service.product.CrmProductService;
...
public class CrmBusinessServiceImpl implements CrmBusinessService {
    ...
    public void updateBusiness(CrmBusinessSaveReqVO updateReqVO) {
        ...
        crmBusinessMapper.updateById(updateObj);
        // 2.2 更新商机关联商品
    ...
    public void updateBusinessFollowUp(Long id, LocalDateTime contactNextTime, String contactLastContent) {
        ...
        // 2. 更新联系人的跟进信息
        crmBusinessMapper.updateById(new CrmBusinessDO().setId(id).setFollowUpStatus(true).setContactNextTime(contactNextTime)
    ...
    public void updateBusinessContactNextTime(Collection<Long> ids, LocalDateTime contactNextTime) {
        crmBusinessMapper.updateBatch(convertList(ids, id -> new CrmBusinessDO().setId(id).setContactNextTime(contactNextTime)));
    }

    private void updateBusinessProduct(Long id, List<CrmBusinessProductDO> newList) {
        List<CrmBusinessProductDO> oldList = crmBusinessProductMapper.selectListByBusinessId(id);
        ...
        if (CollUtil.isNotEmpty(diffList.get(0))) {
            ...
            crmBusinessProductMapper.insertBatch(diffList.get(0));
        }
        if (CollUtil.isNotEmpty(diffList.get(1))) {
            crmBusinessProductMapper.updateBatch(diffList.get(1));
        }
        if (CollUtil.isNotEmpty(diffList.get(2))) {
            crmBusinessProductMapper.deleteByIds(convertSet(diffList.get(2), CrmBusinessProductDO::getId));
        }
    }
    ...
    public void updateBusinessStatus(CrmBusinessUpdateStatusReqVO reqVO) {
        ...
        // 2. 更新商机状态
        crmBusinessMapper.updateById(new CrmBusinessDO().setId(reqVO.getId()).setStatusId(reqVO.getStatusId())
    ...
    public void deleteBusiness(Long id) {
        ...
        // 删除商机
        crmBusinessMapper.deleteById(id);
        // 删除数据权限
    ...
    private CrmBusinessDO validateBusinessExists(Long id) {
        CrmBusinessDO crmBusiness = crmBusinessMapper.selectById(id);
        if (crmBusiness == null) {
    ...
    public void transferBusiness(CrmBusinessTransferReqVO reqVO, Long userId) {
        ...
        // 2.2 设置新的负责人
        crmBusinessMapper.updateOwnerUserIdById(reqVO.getId(), reqVO.getNewOwnerUserId());
    ...
    public CrmBusinessDO getBusiness(Long id) {
        return crmBusinessMapper.selectById(id);
    }
    ...
    public PageResult<CrmBusinessDO> getBusinessPageByContact(CrmBusinessPageReqVO pageReqVO) {
        ...
        // 2. 查询商机分页
        return crmBusinessMapper.selectPageByContactId(pageReqVO,
    ...
    public Long getBusinessCountByCustomerId(Long customerId) {
        return crmBusinessMapper.selectCount(CrmBusinessDO::getCustomerId, customerId);
    }

    @Override
    public Long getBusinessCountByStatusTypeId(Long statusTypeId) {
        return crmBusinessMapper.selectCountByStatusTypeId(statusTypeId);
    }

    @Override
    public List<CrmBusinessDO> getBusinessListByCustomerIdOwnerUserId(Long customerId, Long ownerUserId) {
        return crmBusinessMapper.selectListByCustomerIdOwnerUserId(customerId, ownerUserId);
    }

    @Override
    public PageResult<CrmBusinessDO> getBusinessPageByDate(CrmStatisticsFunnelReqVO pageVO) {
        return crmBusinessMapper.selectPage(pageVO);
    }
