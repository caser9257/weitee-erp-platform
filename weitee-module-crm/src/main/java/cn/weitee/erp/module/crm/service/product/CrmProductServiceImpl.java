package cn.weitee.erp.module.crm.service.product;

import cn.hutool.core.collection.CollUtil;
import cn.weitee.erp.framework.common.pojo.PageResult;
import cn.weitee.erp.framework.common.util.object.BeanUtils;
import cn.weitee.erp.module.crm.controller.admin.product.vo.product.CrmProductPageReqVO;
import cn.weitee.erp.module.crm.controller.admin.product.vo.product.CrmProductSaveReqVO;
import cn.weitee.erp.module.crm.dal.dataobject.product.CrmProductCategoryDO;
import cn.weitee.erp.module.crm.dal.dataobject.product.CrmProductDO;
import cn.weitee.erp.module.crm.dal.mysql.product.CrmProductMapper;
...
import cn.weitee.erp.module.crm.enums.product.CrmProductStatusEnum;
...
public class CrmProductServiceImpl implements CrmProductService {
    ...
    public void updateProduct(CrmProductSaveReqVO updateReqVO) {
        ...
        crmProductMapper.updateById(updateObj);
    ...
    private CrmProductDO validateProductExists(Long id) {
        CrmProductDO product = crmProductMapper.selectById(id);
        if (product == null) {
    ...
    private void validateProductNoDuplicate(Long id, String no) {
        CrmProductDO product = crmProductMapper.selectByNo(no);
        if (product == null
    ...
    public void deleteProduct(Long id) {
        ...
        // 删除
        crmProductMapper.deleteById(id);
    }
    ...
    public CrmProductDO getProduct(Long id) {
        return crmProductMapper.selectById(id);
    }

    @Override
    public PageResult<CrmProductDO> getProductPage(CrmProductPageReqVO pageReqVO) {
        return crmProductMapper.selectPage(pageReqVO);
    }

    @Override
    public Long getProductByCategoryId(Long categoryId) {
        return crmProductMapper.selectCountByCategoryId(categoryId);
    }

    @Override
    public List<CrmProductDO> getProductListByStatus(Integer status) {
        return crmProductMapper.selectListByStatus(status);
    }
    ...
    public List<CrmProductDO> validProductList(Collection<Long> ids) {
        ...
        List<CrmProductDO> list = crmProductMapper.selectByIds(ids);
    ...
    public List<CrmProductDO> getProductList(Collection<Long> ids) {
        ...
        return crmProductMapper.selectByIds(ids);
    }
