...
import cn.weitee.erp.module.crm.controller.admin.contact.vo.CrmContactPageReqVO;
import cn.weitee.erp.module.crm.controller.admin.contact.vo.CrmContactSaveReqVO;
...
import cn.weitee.erp.module.crm.dal.mysql.contact.CrmContactMapper;
...
import static cn.weitee.erp.framework.common.pojo.PageParam.PAGE_SIZE_NONE;
...
public class CrmContactServiceImpl implements CrmContactService {
    ...
    public List<CrmContactDO> getContactList(Collection<Long> ids) {
        ...
        return crmContactMapper.selectByIds(ids);
    }
