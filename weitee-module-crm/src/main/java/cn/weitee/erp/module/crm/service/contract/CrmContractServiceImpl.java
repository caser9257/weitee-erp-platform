...
import cn.weitee.erp.module.crm.controller.admin.contract.vo.contract.CrmContractPageReqVO;
import cn.weitee.erp.module.crm.controller.admin.contract.vo.contract.CrmContractSaveReqVO;
...
import cn.weitee.erp.module.crm.dal.mysql.contract.CrmContractMapper;
import cn.weitee.erp.module.crm.dal.mysql.contract.CrmContractProductMapper;
import cn.weitee.erp.module.crm.dal.redis.no.CrmNoRedisDAO;
import cn.weitee.erp.module.crm.enums.common.CrmAuditStatusEnum;
...
import cn.weitee.erp.module.crm.service.receivable.CrmReceivableService;
...
import static cn.weitee.erp.module.crm.util.CrmAuditStatusUtils.convertBpmResultToAuditStatus;
...
public class CrmContractServiceImpl implements CrmContractService {
    ...
    @Resource
    private CrmContractProductMapper crmContractProductMapper;
    ...
    public Long createContract(CrmContractSaveReqVO createReqVO, Long userId) {
        ...
        if (crmContractMapper.selectByNo(no) != null) {
        ...
        if (CollUtil.isNotEmpty(contractProducts)) {
            ...
            crmContractProductMapper.insertBatch(contractProducts);
        }
    ...
    public void updateContract(CrmContractSaveReqVO updateReqVO) {
        ...
        crmContractMapper.updateById(updateObj);
        // 2.2 更新合同关联商品
    ...
    private void updateContractProduct(Long id, List<CrmContractProductDO> newList) {
        List<CrmContractProductDO> oldList = crmContractProductMapper.selectListByContractId(id);
        ...
        if (CollUtil.isNotEmpty(diffList.get(0))) {
            ...
            crmContractProductMapper.insertBatch(diffList.get(0));
        }
        if (CollUtil.isNotEmpty(diffList.get(1))) {
            crmContractProductMapper.updateBatch(diffList.get(1));
        }
        if (CollUtil.isNotEmpty(diffList.get(2))) {
            crmContractProductMapper.deleteByIds(convertSet(diffList.get(2), CrmContractProductDO::getId));
        }
    }
    ...
    public void deleteContract(Long id) {
        ...
        // 2.1 删除合同
        crmContractMapper.deleteById(id);
        // 2.2 删除数据权限
    ...
    private CrmContractDO validateContractExists(Long id) {
        CrmContractDO contract = crmContractMapper.selectById(id);
        if (contract == null) {
    ...
    public void transferContract(CrmContractTransferReqVO reqVO, Long userId) {
        ...
        // 2.2 设置负责人
        crmContractMapper.updateById(new CrmContractDO().setId(reqVO.getId()).setOwnerUserId(reqVO.getNewOwnerUserId()));
    ...
    public void updateContractFollowUp(Long id, LocalDateTime contactNextTime, String contactLastContent) {
        ...
        // 2. 更新联系人的跟进信息
        crmContractMapper.updateById(new CrmContractDO().setId(id).setContactLastTime(LocalDateTime.now()));
    ...
    public void submitContract(Long id, Long userId) {
        ...
        // 3. 更新合同工作流编号
        crmContractMapper.updateById(new CrmContractDO().setId(id).setProcessInstanceId(processInstanceId)
    ...
    public void updateContractAuditStatus(Long id, Integer bpmResult) {
        ...
        crmContractMapper.updateById(new CrmContractDO().setId(id).setAuditStatus(auditStatus));
    }
    ...
    public CrmContractDO getContract(Long id) {
        return crmContractMapper.selectById(id);
    }
    ...
    public List<CrmContractDO> getContractList(Collection<Long> ids) {
        ...
        return crmContractMapper.selectByIds(ids);
    }
    ...
    public PageResult<CrmContractDO> getContractPage(CrmContractPageReqVO pageReqVO, Long userId) {
        ...
        // 2. 查询分页
        return crmContractMapper.selectPage(pageReqVO, userId, config);
    }

    @Override
    @CrmPermission(bizType = CrmBizTypeEnum.CRM_CUSTOMER, bizId = "#pageReqVO.customerId", level = CrmPermissionLevelEnum.READ)
    public PageResult<CrmContractDO> getContractPageByCustomerId(CrmContractPageReqVO pageReqVO) {
        return crmContractMapper.selectPageByCustomerId(pageReqVO);
    }
    ...
    public PageResult<CrmContractDO> getContractPageByBusinessId(CrmContractPageReqVO pageReqVO) {
        return crmContractMapper.selectPageByBusinessId(pageReqVO);
    }

    @Override
    public Long getContractCountByContactId(Long contactId) {
        return crmContractMapper.selectCountByContactId(contactId);
    }

    @Override
    public Long getContractCountByCustomerId(Long customerId) {
        return crmContractMapper.selectCount(CrmContractDO::getCustomerId, customerId);
    }

    @Override
    public Long getContractCountByBusinessId(Long businessId) {
        return crmContractMapper.selectCountByBusinessId(businessId);
    }

    @Override
    public List<CrmContractProductDO> getContractProductListByContractId(Long contactId) {
        return crmContractProductMapper.selectListByContractId(contactId);
    }

    @Override
    public Long getAuditContractCount(Long userId) {
        return crmContractMapper.selectCountByAudit(userId);
    }
    ...
    public Long getRemindContractCount(Long userId) {
        ...
        return crmContractMapper.selectCountByRemind(userId, config);
    }

    @Override
    public List<CrmContractDO> getContractListByCustomerIdOwnerUserId(Long customerId, Long ownerUserId) {
        return crmContractMapper.selectListByCustomerIdOwnerUserId(customerId, ownerUserId);
    }
