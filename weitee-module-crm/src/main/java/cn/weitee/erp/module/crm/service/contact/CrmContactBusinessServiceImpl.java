package cn.weitee.erp.module.crm.service.contact;

import cn.hutool.core.collection.CollUtil;
import cn.weitee.erp.module.crm.controller.admin.contact.vo.CrmContactBusiness2ReqVO;
...
import cn.weitee.erp.module.crm.dal.mysql.contact.CrmContactBusinessMapper;
...
import static cn.weitee.erp.module.crm.enums.ErrorCodeConstants.CONTACT_NOT_EXISTS;
...
public class CrmContactBusinessServiceImpl implements CrmContactBusinessService {
    ...
    @Resource
    private CrmContactBusinessMapper crmContactBusinessMapper;
    ...
    public void createContactBusinessList(CrmContactBusinessReqVO createReqVO) {
        ...
        createReqVO.getBusinessIds().forEach(businessId -> {
            ...
            // 关联判重
            if (crmContactBusinessMapper.selectByContactIdAndBusinessId(createReqVO.getContactId(), businessId) != null) {
                return;
            }
        ...
        if (CollUtil.isNotEmpty(saveDOList)) {
            crmContactBusinessMapper.insertBatch(saveDOList);
        }
    }
    ...
    public void createContactBusinessList2(CrmContactBusiness2ReqVO createReqVO) {
        ...
        createReqVO.getContactIds().forEach(contactId -> {
            ...
            // 关联判重
            if (crmContactBusinessMapper.selectByContactIdAndBusinessId(contactId, createReqVO.getBusinessId()) != null) {
                return;
            }
    ...
    public void deleteContactBusinessList(CrmContactBusinessReqVO deleteReqVO) {
        ...
        // 直接删除
        crmContactBusinessMapper.deleteByContactIdAndBusinessId(
    ...
    public void deleteContactBusinessList2(CrmContactBusiness2ReqVO deleteReqVO) {
        ...
        // 直接删除
        crmContactBusinessMapper.deleteByBusinessIdAndContactId(
    ...
    public void deleteContactBusinessByContactId(Long contactId) {
        crmContactBusinessMapper.delete(CrmContactBusinessDO::getContactId, contactId);
    }
    ...
    public List<CrmContactBusinessDO> getContactBusinessListByContactId(Long contactId) {
        return crmContactBusinessMapper.selectListByContactId(contactId);
    }
    ...
    public List<CrmContactBusinessDO> getContactBusinessListByBusinessId(Long businessId) {
        return crmContactBusinessMapper.selectListByBusinessId(businessId);
    }
