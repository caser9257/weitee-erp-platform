...
import cn.weitee.erp.module.crm.controller.admin.statistics.vo.portrait.*;
import cn.weitee.erp.module.crm.dal.mysql.statistics.CrmStatisticsPortraitMapper;
...
public class CrmStatisticsPortraitServiceImpl implements CrmStatisticsPortraitService {
    ...
    @Resource
    private CrmStatisticsPortraitMapper crmStatisticsPortraitMapper;
    ...
    public List<CrmStatisticCustomerAreaRespVO> getCustomerSummaryByArea(CrmStatisticsPortraitReqVO reqVO) {
        ...
        // 2. 获取客户地区统计数据
        List<CrmStatisticCustomerAreaRespVO> list = crmStatisticsPortraitMapper.selectSummaryListGroupByAreaId(reqVO);
    ...
    public List<CrmStatisticCustomerIndustryRespVO> getCustomerSummaryByIndustry(CrmStatisticsPortraitReqVO reqVO) {
        ...
        // 2. 获取客户行业统计数据
        return crmStatisticsPortraitMapper.selectCustomerIndustryListGroupByIndustryId(reqVO);
    }
    ...
    public List<CrmStatisticCustomerSourceRespVO> getCustomerSummaryBySource(CrmStatisticsPortraitReqVO reqVO) {
        ...
        // 2. 获取客户行业统计数据
        return crmStatisticsPortraitMapper.selectCustomerSourceListGroupBySource(reqVO);
    }
    ...
    public List<CrmStatisticCustomerLevelRespVO> getCustomerSummaryByLevel(CrmStatisticsPortraitReqVO reqVO) {
        ...
        // 2. 获取客户级别统计数据
        return crmStatisticsPortraitMapper.selectCustomerLevelListGroupByLevel(reqVO);
    }
