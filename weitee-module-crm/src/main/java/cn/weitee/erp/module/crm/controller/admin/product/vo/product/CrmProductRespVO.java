package cn.weitee.erp.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.weitee.erp.module.system.dal.dataobject.user.AdminUserDO",
