package cn.weitee.erp.module.crm.service.clue;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import cn.weitee.erp.framework.common.pojo.PageResult;
import cn.weitee.erp.framework.common.util.object.BeanUtils;
import cn.weitee.erp.module.crm.controller.admin.clue.vo.CrmCluePageReqVO;
import cn.weitee.erp.module.crm.controller.admin.clue.vo.CrmClueSaveReqVO;
import cn.weitee.erp.module.crm.controller.admin.clue.vo.CrmClueTransferReqVO;
import cn.weitee.erp.module.crm.controller.admin.customer.vo.customer.CrmCustomerSaveReqVO;
import cn.weitee.erp.module.crm.dal.dataobject.clue.CrmClueDO;
import cn.weitee.erp.module.crm.dal.dataobject.followup.CrmFollowUpRecordDO;
import cn.weitee.erp.module.crm.dal.mysql.clue.CrmClueMapper;
...
import cn.weitee.erp.module.crm.service.followup.CrmFollowUpRecordService;
import cn.weitee.erp.module.crm.service.followup.bo.CrmFollowUpCreateReqBO;
...
import static cn.weitee.erp.module.crm.enums.ErrorCodeConstants.CLUE_NOT_EXISTS;
import static cn.weitee.erp.module.crm.enums.ErrorCodeConstants.CLUE_TRANSFORM_FAIL_ALREADY;
...
public class CrmClueServiceImpl implements CrmClueService {
    ...
    public void updateClue(CrmClueSaveReqVO updateReqVO) {
        ...
        crmClueMapper.updateById(updateObj);
    ...
    public void updateClueFollowUp(Long id, LocalDateTime contactNextTime, String contactLastContent) {
        ...
        // 更新线索
        crmClueMapper.updateById(new CrmClueDO().setId(id).setFollowUpStatus(true).setContactNextTime(contactNextTime)
    ...
    public void transferClue(CrmClueTransferReqVO reqVO, Long userId) {
        ...
        // 2.2 设置新的负责人
        crmClueMapper.updateById(new CrmClueDO().setId(reqVO.getId()).setOwnerUserId(reqVO.getNewOwnerUserId()));
    ...
    public void transformClue(Long id, Long userId) {
        ...
        // 2.2 更新线索
        crmClueMapper.updateById(new CrmClueDO().setId(id).setTransformStatus(Boolean.TRUE).setCustomerId(customerId));
        // 2.3 复制跟进记录
    ...
    private CrmClueDO validateClueExists(Long id) {
        CrmClueDO crmClueDO = crmClueMapper.selectById(id);
        if (crmClueDO == null) {
    ...
    public CrmClueDO getClue(Long id) {
        return crmClueMapper.selectById(id);
    }

    @Override
    public PageResult<CrmClueDO> getCluePage(CrmCluePageReqVO pageReqVO, Long userId) {
        return crmClueMapper.selectPage(pageReqVO, userId);
    }

    @Override
    public Long getFollowClueCount(Long userId) {
        return crmClueMapper.selectCountByFollow(userId);
    }
