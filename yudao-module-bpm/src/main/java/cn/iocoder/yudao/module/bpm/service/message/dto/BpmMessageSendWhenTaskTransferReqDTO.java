 ...
 */
@Data
@Schema(description = "任务转办时发送消息的 DTO")
public class BpmMessageSendWhenTaskTransferReqDTO {
    ...
    @Schema(description = "新审批人的用户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    @NotNull(message = "新审批人的用户编号不能为空")
    private Long newAssigneeUserId;

    @Schema(description = "原审批人的用户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    @NotNull(message = "原审批人的用户编号不能为空")
    private Long oldAssigneeUserId;

    @Schema(description = "转办原因", example = "不属于我的职责范围")
