package cn.weitee.erp.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode DEPT_PARENT_NAME_AMBIGUOUS = new ErrorCode(1_002_004_009, "存在多个名称为【{}】的上级部门，请改用唯一名称后再导入");
    ErrorCode DEPT_LEADER_USER_NOT_EXISTS = new ErrorCode(1_002_004_010, "负责人账号【{}】不存在");
    ErrorCode DEPT_LEADER_USER_NOT_ENABLE = new ErrorCode(1_002_004_011, "负责人账号【{}】已被禁用");
    ...
    ErrorCode DICT_DATA_BATCH_UPDATE_FIELD_NOT_SUPPORT = new ErrorCode(1_002_007_004, "批量修改字段【{}】不支持");
    ErrorCode DICT_DATA_BATCH_UPDATE_FIELD_VALUE_INVALID = new ErrorCode(1_002_007_005, "批量修改字段【{}】的值【{}】不合法");

    // ========== 通知公告 1-002-008-000 ==========
    ErrorCode NOTICE_NOT_FOUND = new ErrorCode(1_002_008_001, "当前通知公告不存在");
    ErrorCode NOTICE_BATCH_UPDATE_FIELD_NOT_SUPPORT = new ErrorCode(1_002_008_002, "批量修改字段【{}】不支持");
    ErrorCode NOTICE_BATCH_UPDATE_FIELD_VALUE_INVALID = new ErrorCode(1_002_008_003, "批量修改字段【{}】的值【{}】不合法");
