package cn.weitee.erp.module.system.controller.admin.dict.vo.data;
...
@Schema(description = "管理后台 - 字典数据批量修改 Response VO")
@Data
public class DictDataBatchUpdateResultVO {
    ...
    public static class FailedItemVO {
        ...
        @Schema(description = "字典数据编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
        private Long id;

        @Schema(description = "失败原因", requiredMode = Schema.RequiredMode.REQUIRED, example = "当前字典数据不存在")
