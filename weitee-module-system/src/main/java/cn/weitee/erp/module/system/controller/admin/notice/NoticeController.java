package cn.weitee.erp.module.system.controller.admin.notice;
...
import cn.weitee.erp.module.infra.api.websocket.WebSocketSenderApi;
...
import cn.weitee.erp.module.system.controller.admin.notice.vo.NoticeRespVO;
...
import cn.weitee.erp.module.system.service.notice.NoticeService;
...
public class NoticeController {
    ...
    @Operation(summary = "批量修改通知公告")
    @PreAuthorize("@ss.hasPermission('system:notice:update')")
    public CommonResult<NoticeBatchUpdateResultVO> updateNoticeBatch(@Valid @RequestBody NoticeBatchUpdateReqVO reqVO) {
        return success(noticeService.updateNoticeBatch(reqVO));
    }
