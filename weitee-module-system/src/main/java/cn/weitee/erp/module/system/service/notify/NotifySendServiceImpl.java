...
public class NotifySendServiceImpl implements NotifySendService {
    ...
    private static final String NOTIFY_MESSAGE_CREATE_TYPE = "notify-message-create";
    ...
    public Long sendSingleNotify(Long userId, Integer userType, String templateCode, Map<String, Object> templateParams) {
        ...
        webSocketSenderApi.sendObject(userType, userId, NOTIFY_MESSAGE_CREATE_TYPE,
                buildWebSocketMessage(messageId, template, content));
        return messageId;
    }

    private Map<String, Object> buildWebSocketMessage(Long messageId, NotifyTemplateDO template, String content) {
        return Map.of(
                "id", messageId,
