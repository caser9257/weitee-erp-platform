...
import cn.weitee.erp.module.system.controller.admin.dict.vo.data.DictDataRespVO;
import cn.weitee.erp.module.system.controller.admin.dict.vo.data.DictDataSaveReqVO;
import cn.weitee.erp.module.system.controller.admin.dict.vo.data.DictDataSimpleRespVO;
...
public class DictDataController {
    ...
    @Operation(summary = "批量修改字典数据")
    @PreAuthorize("@ss.hasPermission('system:dict:update')")
    public CommonResult<DictDataBatchUpdateResultVO> updateDictDataBatch(@Valid @RequestBody DictDataBatchUpdateReqVO reqVO) {
        return success(dictDataService.updateDictDataBatch(reqVO));
    }
