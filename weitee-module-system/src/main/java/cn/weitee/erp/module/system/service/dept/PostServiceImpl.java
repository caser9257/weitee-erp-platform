...
import cn.weitee.erp.module.system.controller.admin.dept.vo.post.PostPageReqVO;
import cn.weitee.erp.module.system.controller.admin.dept.vo.post.PostSaveReqVO;
...
public class PostServiceImpl implements PostService {
    ...
    private void fillPostDefaults(PostDO post) {
        if (post == null) {
            return;
        }
        post.setStaffQuota(Objects.requireNonNullElse(post.getStaffQuota(), 1));
        post.setKeyPosition(Objects.requireNonNullElse(post.getKeyPosition(), Boolean.FALSE));
        post.setAllowPartTime(Objects.requireNonNullElse(post.getAllowPartTime(), Boolean.FALSE));
    }
