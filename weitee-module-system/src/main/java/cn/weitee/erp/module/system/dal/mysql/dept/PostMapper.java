...
public interface PostMapper extends BaseMapperX<PostDO> {
    ...
    default PageResult<PostDO> selectPage(PostPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<PostDO>()
                ...
                .eqIfPresent(PostDO::getLevel, reqVO.getLevel())
                .eqIfPresent(PostDO::getDeptId, reqVO.getDeptId())
                .eqIfPresent(PostDO::getKeyPosition, reqVO.getKeyPosition())
    ...
    default List<PostDO> selectListByDeptIds(Collection<Long> deptIds, Collection<Integer> statuses) {
        return selectList(new LambdaQueryWrapperX<PostDO>()
