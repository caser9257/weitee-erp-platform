package cn.weitee.erp.module.system.service.social;
...
import cn.weitee.erp.framework.common.util.cache.CacheUtils;
import cn.weitee.erp.framework.common.util.http.HttpUtils;
import cn.weitee.erp.framework.common.util.object.BeanUtils;
import cn.weitee.erp.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.weitee.erp.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.weitee.erp.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.weitee.erp.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.weitee.erp.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.weitee.erp.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.weitee.erp.module.system.dal.dataobject.social.SocialClientDO;
import cn.weitee.erp.module.system.dal.mysql.social.SocialClientMapper;
import cn.weitee.erp.module.system.dal.redis.RedisKeyConstants;
import cn.weitee.erp.module.system.enums.social.SocialTypeEnum;
import cn.weitee.erp.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.weitee.erp.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.weitee.erp.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.weitee.erp.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
    ...
    @Resource
    private StringRedisTemplate stringRedisTemplate; // WxMaService 需要使用到，所以在 Service 注入了它
    /**
     * 缓存 WxMaService 对象
     *
    ...
    /**
     * 获得 clientId + clientSecret 对应的 WxMaService 对象
     *
     * @param userType 用户类型
