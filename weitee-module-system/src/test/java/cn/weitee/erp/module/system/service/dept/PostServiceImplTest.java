...
public class PostServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetPostPage() {
        ...
        // 测试 deptId 不匹配
        postMapper.insert(cloneIgnoreId(postDO, o -> o.setDeptId(20L)));
        // 测试 level 不匹配
        postMapper.insert(cloneIgnoreId(postDO, o -> o.setLevel("初级")));
        // 准备参数
    ...
    private static PostDO randomPostDO(Consumer<PostDO>... consumers) {
        Consumer<PostDO> consumer = (o) -> {
            ...
            o.setLevel(randomEle(new String[]{"高级", "中级", "初级"}));
            o.setDeptId(randomLongId());
            o.setStaffQuota(Math.abs(randomInteger()) % 10 + 1);
            o.setKeyPosition(randomBoolean());
            o.setAllowPartTime(randomBoolean());
            o.setJobDescription(randomString());
        };
