...
SET 
	   ...
	   <#if jimuReportDb.isList ?exists>
        ...
        <#if jimuReportDb.izSharedSource ?exists>
            IZ_SHARED_SOURCE = :jimuReportDb.izSharedSource,
        </#if>
        <#if jimuReportDb.jimuSharedSourceId ?exists>
            JIMU_SHARED_SOURCE_ID = :jimuReportDb.jimuSharedSourceId,
        </#if>
