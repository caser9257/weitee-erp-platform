...
SELECT 'users_current' AS label, COUNT(*) AS value FROM `ruoyi-vue-pro`.system_users;
SELECT 'menu_restore' AS label, COUNT(*) AS value FROM ruoyi_vue_pro_restore.system_menu;
SELECT 'menu_current' AS label, COUNT(*) AS value FROM `ruoyi-vue-pro`.system_menu;
SELECT 'role_restore' AS label, COUNT(*) AS value FROM ruoyi_vue_pro_restore.system_role;
SELECT 'role_current' AS label, COUNT(*) AS value FROM `ruoyi-vue-pro`.system_role;
...
FROM `ruoyi-vue-pro`.system_notify_template
WHERE code = 'bpm_task_assigned';
