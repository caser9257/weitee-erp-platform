...
`C:\Users\Administrator\.tester\skills\awesome-design-md\assets\awesome-design-md`

The DESIGN.md collection is here:

`C:\Users\Administrator\.tester\skills\awesome-design-md\assets\awesome-design-md\design-md`
...
2. The upstream repo is not a native Tester skill repo, so this wrapper is required for Tester to load it as a skill.
