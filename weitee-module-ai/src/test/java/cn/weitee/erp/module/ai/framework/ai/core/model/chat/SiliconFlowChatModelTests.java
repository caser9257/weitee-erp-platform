package cn.weitee.erp.module.ai.framework.ai.core.model.chat;
...
//                    .model("deepseek-ai/DeepSeek-R1") // 模型（deepseek-ai/DeepSeek-R1）可用赠�?
//                    .model("Pro/deepseek-ai/DeepSeek-R1") // 模型（Pro/deepseek-ai/DeepSeek-R1）需要付�?
                    .temperature(0.7)
                    .build())
            .build();
