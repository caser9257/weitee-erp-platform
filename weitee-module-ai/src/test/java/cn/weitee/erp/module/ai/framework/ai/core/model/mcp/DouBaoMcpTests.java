package cn.weitee.erp.module.ai.framework.ai.core.model.mcp;
...
public class DouBaoMcpTests {
    ...
    static class UserService {
        ...
        public String getUserSex(String userName) {
            return "�? + userName + "》的性别为：�?;
        }

        @Tool(name = "getUserBasicInfo", description = "获取用户基本信息，包括姓名、年龄、性别�?)
