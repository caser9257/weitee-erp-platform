package cn.weitee.erp.module.ai.controller.admin.write.vo;
...
public class AiWriteGenerateReqVO {
    ...
    @InEnum(value = AiWriteTypeEnum.class, message = "写作类型必须�?{value}")
    private Integer type;

    @Schema(description = "写作内容提示", example = "1.撰写：田忌赛马；2.回复：不�?)
