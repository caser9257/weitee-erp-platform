package cn.weitee.erp.module.ai.service.music;
...
import cn.weitee.erp.module.ai.controller.admin.music.vo.AiMusicPageReqVO;
import cn.weitee.erp.module.ai.controller.admin.music.vo.AiMusicUpdateMyReqVO;
import cn.weitee.erp.module.ai.controller.admin.music.vo.AiMusicUpdateReqVO;
import cn.weitee.erp.module.ai.controller.admin.music.vo.AiSunoGenerateReqVO;
import cn.weitee.erp.module.ai.dal.dataobject.music.AiMusicDO;
import cn.weitee.erp.module.ai.dal.mysql.music.AiMusicMapper;
import cn.weitee.erp.module.ai.enums.music.AiMusicGenerateModeEnum;
import cn.weitee.erp.module.ai.enums.music.AiMusicStatusEnum;
import cn.weitee.erp.module.ai.service.model.AiModelService;
import cn.weitee.erp.module.infra.api.file.FileApi;
...
import static cn.weitee.erp.module.ai.enums.ErrorCodeConstants.IMAGE_NOT_EXISTS;
import static cn.weitee.erp.module.ai.enums.ErrorCodeConstants.MUSIC_NOT_EXISTS;
...
public class AiMusicServiceImpl implements AiMusicService {
    ...
    @Resource
    private AiMusicMapper aiMusicMapper;
    ...
    public List<Long> generateMusic(Long userId, AiSunoGenerateReqVO reqVO) {
        ...
        aiMusicMapper.insertBatch(musicList);
        return convertList(musicList, AiMusicDO::getId);
    }

    @Override
    public Integer syncMusic() {
        List<AiMusicDO> streamingTask = aiMusicMapper.selectListByStatus(AiMusicStatusEnum.IN_PROGRESS.getStatus());
        ...
        CollUtil.split(streamingTask, 36).forEach(chunkList -> {
            ...
            aiMusicMapper.updateBatch(updateMusicList);
        });
    ...
    public void updateMusic(AiMusicUpdateReqVO updateReqVO) {
        ...
        // 更新
        aiMusicMapper.updateById(new AiMusicDO().setId(updateReqVO.getId()).setPublicStatus(updateReqVO.getPublicStatus()));
    }
    ...
    public void updateMyMusic(AiMusicUpdateMyReqVO updateReqVO, Long userId) {
        ...
        // 更新
        aiMusicMapper.updateById(new AiMusicDO().setId(updateReqVO.getId()).setTitle(updateReqVO.getTitle()));
    }
    ...
    private AiMusicDO validateMusicExists(Long id) {
        AiMusicDO music = aiMusicMapper.selectById(id);
        if (music == null) {
            throw exception(MUSIC_NOT_EXISTS);
        }
        return music;
