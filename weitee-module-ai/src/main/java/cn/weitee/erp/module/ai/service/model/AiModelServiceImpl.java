...
import cn.weitee.erp.module.ai.controller.admin.model.vo.model.AiModelPageReqVO;
import cn.weitee.erp.module.ai.controller.admin.model.vo.model.AiModelSaveReqVO;
...
import cn.weitee.erp.module.ai.dal.mysql.model.AiChatMapper;
...
public class AiModelServiceImpl implements AiModelService {
    ...
    public void updateModel(AiModelSaveReqVO updateReqVO) {
        ...
        aiChatMapper.updateById(updateObj);
    }
    ...
    public void deleteModel(Long id) {
        ...
        // 删除
        aiChatMapper.deleteById(id);
    }

    private AiModelDO validateModelExists(Long id) {
        AiModelDO model = aiChatMapper.selectById(id);
        if (aiChatMapper.selectById(id) == null) {
    ...
    public AiModelDO getModel(Long id) {
        return aiChatMapper.selectById(id);
    }

    @Override
    public AiModelDO getRequiredDefaultModel(Integer type) {
        AiModelDO model = aiChatMapper.selectFirstByStatus(type, CommonStatusEnum.ENABLE.getStatus());
        if (model == null) {
    ...
    public PageResult<AiModelDO> getModelPage(AiModelPageReqVO pageReqVO) {
        return aiChatMapper.selectPage(pageReqVO);
    }
