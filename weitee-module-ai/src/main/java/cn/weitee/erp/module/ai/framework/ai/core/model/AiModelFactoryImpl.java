package cn.weitee.erp.module.ai.framework.ai.core.model;
...
import cn.weitee.erp.module.ai.enums.model.AiPlatformEnum;
import cn.weitee.erp.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.weitee.erp.module.ai.framework.ai.config.WeiteeAiProperties;
import cn.weitee.erp.module.ai.framework.ai.core.model.baichuan.BaiChuanChatModel;
import cn.weitee.erp.module.ai.framework.ai.core.model.doubao.DouBaoChatModel;
import cn.weitee.erp.module.ai.framework.ai.core.model.gemini.GeminiChatModel;
import cn.weitee.erp.module.ai.framework.ai.core.model.hunyuan.HunYuanChatModel;
import cn.weitee.erp.module.ai.framework.ai.core.model.midjourney.api.MidjourneyApi;
import cn.weitee.erp.module.ai.framework.ai.core.model.siliconflow.SiliconFlowApiConstants;
import cn.weitee.erp.module.ai.framework.ai.core.model.siliconflow.SiliconFlowChatModel;
import cn.weitee.erp.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.weitee.erp.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
import cn.weitee.erp.module.ai.framework.ai.core.model.suno.api.SunoApi;
import cn.weitee.erp.module.ai.framework.ai.core.model.xinghuo.XingHuoChatModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            WeiteeAiProperties.Midjourney properties = SpringUtil.getBean(WeiteeAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参�?{@link AiAutoConfiguration#douBaoChatClient(WeiteeAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        WeiteeAiProperties.DouBao properties = new WeiteeAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参�?{@link AiAutoConfiguration#hunYuanChatClient(WeiteeAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        WeiteeAiProperties.HunYuan properties = new WeiteeAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参�?{@link AiAutoConfiguration#siliconFlowChatClient(WeiteeAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        WeiteeAiProperties.SiliconFlow properties = new WeiteeAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参�?{@link AiAutoConfiguration#xingHuoChatClient(WeiteeAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        WeiteeAiProperties.XingHuo properties = new WeiteeAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参�?{@link AiAutoConfiguration#baiChuanChatClient(WeiteeAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        WeiteeAiProperties.BaiChuan properties = new WeiteeAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参�?{@link AiAutoConfiguration#buildGeminiChatClient(WeiteeAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        WeiteeAiProperties.Gemini properties = SpringUtil.getBean(WeiteeAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        WeiteeAiProperties.Grok properties = new WeiteeAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
