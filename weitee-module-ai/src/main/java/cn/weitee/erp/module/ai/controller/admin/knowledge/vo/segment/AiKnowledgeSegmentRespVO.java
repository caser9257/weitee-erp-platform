package cn.weitee.erp.module.ai.controller.admin.knowledge.vo.segment;

import io.swagger.v3.oas.annotations.media.Schema;
import lombok.Data;

@Schema(description = "管理后台 - AI 知识库文档分�?Response VO")
@Data
public class AiKnowledgeSegmentRespVO {
    ...
    @Schema(description = "知识库编�?, requiredMode = Schema.RequiredMode.REQUIRED, example = "24790")
    private Long knowledgeId;

    @Schema(description = "向量库编�?, requiredMode = Schema.RequiredMode.REQUIRED, example = "1858496a-1dde-4edf-a43e-0aed08f37f8c")
    ...
    @Schema(description = "文档状�?, requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
