package cn.weitee.erp.module.ai.service.write;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import cn.weitee.erp.framework.dict.core.DictFrameworkUtils;
import cn.weitee.erp.module.ai.enums.model.AiModelTypeEnum;
...
import cn.weitee.erp.module.ai.controller.admin.write.vo.AiWriteGenerateReqVO;
import cn.weitee.erp.module.ai.controller.admin.write.vo.AiWritePageReqVO;
...
import cn.weitee.erp.module.ai.dal.dataobject.write.AiWriteDO;
import cn.weitee.erp.module.ai.dal.mysql.write.AiWriteMapper;
import cn.weitee.erp.module.ai.enums.AiChatRoleEnum;
import cn.weitee.erp.module.ai.enums.DictTypeConstants;
import cn.weitee.erp.module.ai.enums.ErrorCodeConstants;
import cn.weitee.erp.module.ai.enums.write.AiWriteTypeEnum;
...
public class AiWriteServiceImpl implements AiWriteService {
    ...
    @Resource
    private AiWriteMapper aiWriteMapper;
    ...
    public void deleteWrite(Long id) {
        ...
        // 删除
        aiWriteMapper.deleteById(id);
    }

    private void validateWriteExists(Long id) {
        if (aiWriteMapper.selectById(id) == null) {
    ...
    public PageResult<AiWriteDO> getWritePage(AiWritePageReqVO pageReqVO) {
        return aiWriteMapper.selectPage(pageReqVO);
    }
