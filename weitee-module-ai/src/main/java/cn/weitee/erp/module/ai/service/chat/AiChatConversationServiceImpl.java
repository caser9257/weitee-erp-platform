...
import cn.weitee.erp.module.ai.controller.admin.chat.vo.conversation.AiChatConversationCreateMyReqVO;
import cn.weitee.erp.module.ai.controller.admin.chat.vo.conversation.AiChatConversationPageReqVO;
import cn.weitee.erp.module.ai.controller.admin.chat.vo.conversation.AiChatConversationUpdateMyReqVO;
...
import cn.weitee.erp.module.ai.dal.mysql.chat.AiChatConversationMapper;
import cn.weitee.erp.module.ai.service.knowledge.AiKnowledgeService;
...
import static cn.weitee.erp.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_MODEL_ERROR;
...
public class AiChatConversationServiceImpl implements AiChatConversationService {
    ...
    public void updateChatConversationMy(AiChatConversationUpdateMyReqVO updateReqVO, Long userId) {
        ...
        aiChatConversationMapper.updateById(updateObj);
    }
    ...
    public AiChatConversationDO validateChatConversationExists(Long id) {
        AiChatConversationDO conversation = aiChatConversationMapper.selectById(id);
        if (conversation == null) {
            throw exception(CHAT_CONVERSATION_NOT_EXISTS);
        }
        return conversation;
    ...
    public void deleteChatConversationMyByUnpinned(Long userId) {
        List<AiChatConversationDO> list = aiChatConversationMapper.selectListByUserIdAndPinned(userId, false);
        if (CollUtil.isEmpty(list)) {
            return;
        }
        aiChatConversationMapper.deleteByIds(convertList(list, AiChatConversationDO::getId));
    }
