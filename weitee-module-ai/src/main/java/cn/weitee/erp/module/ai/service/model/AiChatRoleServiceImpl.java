...
import cn.weitee.erp.module.ai.controller.admin.model.vo.chatRole.AiChatRolePageReqVO;
import cn.weitee.erp.module.ai.controller.admin.model.vo.chatRole.AiChatRoleSaveMyReqVO;
import cn.weitee.erp.module.ai.controller.admin.model.vo.chatRole.AiChatRoleSaveReqVO;
import cn.weitee.erp.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.weitee.erp.module.ai.dal.mysql.model.AiChatRoleMapper;
...
import static cn.weitee.erp.module.ai.enums.ErrorCodeConstants.CHAT_ROLE_DISABLE;
import static cn.weitee.erp.module.ai.enums.ErrorCodeConstants.CHAT_ROLE_NOT_EXISTS;
...
public class AiChatRoleServiceImpl implements AiChatRoleService {
    ...
    public Long createChatRole(AiChatRoleSaveReqVO createReqVO) {
        ...
        aiChatRoleMapper.insert(chatRole);
    ...
    public void updateChatRole(AiChatRoleSaveReqVO updateReqVO) {
        ...
        aiChatRoleMapper.updateById(updateObj);
    }
    ...
    public void deleteChatRole(Long id) {
        ...
        // 删除
        aiChatRoleMapper.deleteById(id);
    }
    ...
    private AiChatRoleDO validateChatRoleExists(Long id) {
        AiChatRoleDO chatRole = aiChatRoleMapper.selectById(id);
        if (chatRole == null) {
            throw exception(CHAT_ROLE_NOT_EXISTS);
        }
        return chatRole;
    ...
    public AiChatRoleDO getChatRole(Long id) {
        return aiChatRoleMapper.selectById(id);
    }
    ...
    public List<String> getChatRoleCategoryList() {
        List<AiChatRoleDO> list = aiChatRoleMapper.selectListGroupByCategory(CommonStatusEnum.ENABLE.getStatus());
