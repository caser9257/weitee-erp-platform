...
import cn.weitee.erp.module.ai.controller.admin.knowledge.vo.document.AiKnowledgeDocumentCreateListReqVO;
import cn.weitee.erp.module.ai.controller.admin.knowledge.vo.document.AiKnowledgeDocumentPageReqVO;
import cn.weitee.erp.module.ai.controller.admin.knowledge.vo.document.AiKnowledgeDocumentUpdateReqVO;
import cn.weitee.erp.module.ai.controller.admin.knowledge.vo.document.AiKnowledgeDocumentUpdateStatusReqVO;
import cn.weitee.erp.module.ai.controller.admin.knowledge.vo.knowledge.AiKnowledgeDocumentCreateReqVO;
import cn.weitee.erp.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.weitee.erp.module.ai.dal.mysql.knowledge.AiKnowledgeDocumentMapper;
...
public class AiKnowledgeDocumentServiceImpl implements AiKnowledgeDocumentService {
    ...
    public List<Long> createKnowledgeDocumentList(AiKnowledgeDocumentCreateListReqVO createListReqVO) {
        ...
        aiKnowledgeDocumentMapper.insertBatch(documentDOs);
    ...
    public AiKnowledgeDocumentDO getKnowledgeDocument(Long id) {
        return aiKnowledgeDocumentMapper.selectById(id);
    }
    ...
    public List<AiKnowledgeDocumentDO> getKnowledgeDocumentList(Collection<Long> ids) {
        ...
        return aiKnowledgeDocumentMapper.selectByIds(ids);
    }

    @Override
    public List<AiKnowledgeDocumentDO> getKnowledgeDocumentListByKnowledgeId(Long knowledgeId) {
        return aiKnowledgeDocumentMapper.selectListByKnowledgeId(knowledgeId);
    }
