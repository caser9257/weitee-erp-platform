package cn.weitee.erp.module.ai.framework.ai.config;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.spring.SpringUtil;
import cn.weitee.erp.module.ai.framework.ai.core.model.AiModelFactory;
import cn.weitee.erp.module.ai.framework.ai.core.model.AiModelFactoryImpl;
...
import cn.weitee.erp.module.ai.framework.ai.core.model.grok.GrokChatModel;
...
import cn.weitee.erp.module.ai.framework.ai.core.webserch.bocha.AiBoChaWebSearchClient;
import cn.weitee.erp.module.ai.tool.method.PersonService;
 ...
 */
@Configuration
@EnableConfigurationProperties({ WeiteeAiProperties.class,
...
public class AiAutoConfiguration {
    ...
    public GeminiChatModel buildGeminiChatClient(WeiteeAiProperties.Gemini properties) {
    ...
    public DouBaoChatModel buildDouBaoChatClient(WeiteeAiProperties.DouBao properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public SiliconFlowChatModel buildSiliconFlowChatClient(WeiteeAiProperties.SiliconFlow properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public HunYuanChatModel buildHunYuanChatClient(WeiteeAiProperties.HunYuan properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public XingHuoChatModel buildXingHuoChatClient(WeiteeAiProperties.XingHuo properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public BaiChuanChatModel buildBaiChuanChatClient(WeiteeAiProperties.BaiChuan properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
