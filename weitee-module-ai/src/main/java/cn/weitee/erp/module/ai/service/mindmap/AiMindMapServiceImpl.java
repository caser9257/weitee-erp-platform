package cn.weitee.erp.module.ai.service.mindmap;
...
import cn.weitee.erp.module.ai.controller.admin.mindmap.vo.AiMindMapGenerateReqVO;
import cn.weitee.erp.module.ai.controller.admin.mindmap.vo.AiMindMapPageReqVO;
import cn.weitee.erp.module.ai.dal.dataobject.mindmap.AiMindMapDO;
...
import cn.weitee.erp.module.ai.dal.mysql.mindmap.AiMindMapMapper;
...
public class AiMindMapServiceImpl implements AiMindMapService {
    ...
    @Resource
    private AiMindMapMapper aiMindMapMapper;
    ...
    public Flux<CommonResult<String>> generateMindMap(AiMindMapGenerateReqVO generateReqVO, Long userId) {
        ...
        aiMindMapMapper.insert(mindMapDO);
    ...
    public void deleteMindMap(Long id) {
        ...
        // 删除
        aiMindMapMapper.deleteById(id);
    }

    private void validateMindMapExists(Long id) {
        if (aiMindMapMapper.selectById(id) == null) {
    ...
    public PageResult<AiMindMapDO> getMindMapPage(AiMindMapPageReqVO pageReqVO) {
        return aiMindMapMapper.selectPage(pageReqVO);
    }
