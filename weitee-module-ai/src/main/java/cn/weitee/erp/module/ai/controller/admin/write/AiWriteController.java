package cn.weitee.erp.module.ai.controller.admin.write;
...
import cn.weitee.erp.module.ai.controller.admin.write.vo.AiWriteRespVO;
import cn.weitee.erp.module.ai.dal.dataobject.write.AiWriteDO;
import cn.weitee.erp.module.ai.service.write.AiWriteService;
...
public class AiWriteController {
    ...
    @Operation(summary = "写作生成（流式）", description = "流式返回，响应较�?)
