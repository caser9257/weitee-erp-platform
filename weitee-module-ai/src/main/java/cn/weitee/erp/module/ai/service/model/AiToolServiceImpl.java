...
import cn.weitee.erp.module.ai.controller.admin.model.vo.tool.AiToolPageReqVO;
import cn.weitee.erp.module.ai.controller.admin.model.vo.tool.AiToolSaveReqVO;
import cn.weitee.erp.module.ai.dal.dataobject.model.AiToolDO;
import cn.weitee.erp.module.ai.dal.mysql.model.AiToolMapper;
...
import static cn.weitee.erp.module.ai.enums.ErrorCodeConstants.TOOL_NAME_NOT_EXISTS;
import static cn.weitee.erp.module.ai.enums.ErrorCodeConstants.TOOL_NOT_EXISTS;
...
public class AiToolServiceImpl implements AiToolService {
    ...
    public void updateTool(AiToolSaveReqVO updateReqVO) {
        ...
        aiToolMapper.updateById(updateObj);
    }
    ...
    public void validateToolExists(Long id) {
        if (aiToolMapper.selectById(id) == null) {
    ...
    public List<AiToolDO> getToolList(Collection<Long> ids) {
        return aiToolMapper.selectByIds(ids);
    }

    @Override
    public PageResult<AiToolDO> getToolPage(AiToolPageReqVO pageReqVO) {
        return aiToolMapper.selectPage(pageReqVO);
    }

    @Override
    public List<AiToolDO> getToolListByStatus(Integer status) {
        return aiToolMapper.selectListByStatus(status);
    }
