package cn.weitee.erp.module.ai.controller.admin.mindmap;
...
import cn.weitee.erp.module.ai.controller.admin.mindmap.vo.AiMindMapRespVO;
import cn.weitee.erp.module.ai.dal.dataobject.mindmap.AiMindMapDO;
import cn.weitee.erp.module.ai.service.mindmap.AiMindMapService;
...
public class AiMindMapController {
    ...
    @Operation(summary = "导图生成（流式）", description = "流式返回，响应较�?)
