...
export interface StockOutCancelApprovalReqVO {
  id: number
  reason: string
}
...
export const StockOutApi = {
  ...
  // 提交其它出库单审批
  submitStockOut: async (data: StockOutSubmitReqVO) => {
    return await request.post({ url: `/erp/stock-out/submit`, data })
  },

  // 撤回其它出库单审批
  cancelStockOutApproval: async (data: StockOutCancelApprovalReqVO) => {
    return await request.delete({ url: `/erp/stock-out/cancel-approval`, data })
  },
