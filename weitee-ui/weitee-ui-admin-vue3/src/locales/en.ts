export default {
  ...
  sys: {
    ...
    login: {
      ...
      heroBrandChinese: 'Wave Technic Manufacturing Platform',
      heroCapability: 'A manufacturing collaboration platform connecting MES, ERP, and WMS.',
      heroTagMes: 'Lean Production MES',
      heroTagErp: 'Business Collaboration ERP',
      heroTagWms: 'Intelligent Warehousing WMS',
