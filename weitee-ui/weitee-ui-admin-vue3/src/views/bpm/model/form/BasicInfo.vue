<template>
  <el-form ref="formRef" :model="modelData" :rules="rules" label-width="120px" class="mt-20px">
    <el-form-item v-if="!isQuickMode" label="流程标识" prop="key" class="mb-20px">
    ...
    <el-form-item v-if="!isQuickMode" label="流程图标" class="mb-20px">
      <UploadImg v-model="modelData.icon" :limit="1" height="64px" width="64px" />
    </el-form-item>
    <el-form-item v-if="!isQuickMode" label="流程描述" prop="description" class="mb-20px">
      <el-input v-model="modelData.description" clearable type="textarea" />
    </el-form-item>
    <el-form-item v-if="!isQuickMode" label="流程类型" prop="type" class="mb-20px">
    ...
    <el-form-item v-if="!isQuickMode" label="是否可见" prop="visible" class="mb-20px">
...
const props = defineProps({
  ...
  mode: {
    type: String as PropType<'full' | 'quick'>,
    default: 'full'
  }
})
