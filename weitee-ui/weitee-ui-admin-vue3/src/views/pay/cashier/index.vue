...
const payOrder = ref<Partial<PayOrderApi.OrderVO>>({}) // 支付信息
...
/** 初始化 */
onMounted(() => {
  id.value = route.query.id ? Number(route.query.id) : undefined
  if (route.query.returnUrl) {
    const returnUrlQuery = Array.isArray(route.query.returnUrl)
